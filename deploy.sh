...
## 🎯 Objectif
Chaque commit poussé sur la branche `main` déclenche automatiquement un build et un déploiement vers **Cloudflare Pages**.  
...
- Projet Cloudflare Pages connecté à la branche `main`
