...
function apply(mode){root.classList.toggle("light",mode==="light"); if(btn){btn.textContent=mode==="light"?"🌙 Sombre":"☀️ Clair"; btn.setAttribute("aria-label", mode==="light"?"Activer le thème sombre":"Activer le thème clair");}}
