...
export default function App() {
  ...
  const renderModule = () => {
    switch (activeModule) {
      ...
      default:
        return (
          <div className="max-w-7xl mx-auto p-6 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 min-h-screen text-slate-100">
            <div className="flex flex-col items-center mb-12">
              <img src={require('./assets/images/banniere_site.png')} alt="Bannière A KI PRI SA YÉ" className="w-full max-w-3xl rounded-xl shadow-lg mb-8" />
              <img src={require('./assets/images/logo_hd_4k.png')} alt="Logo A KI PRI SA YÉ" className="w-32 h-32 rounded-full shadow-lg mb-4" />
              <h1 className="text-5xl font-extrabold text-blue-300 mb-4 drop-shadow-lg">A KI PRI SA YÉ</h1>
              <p className="text-2xl text-slate-300 mb-8 font-medium">Comparateur de prix intelligent pour les DROM-COM</p>
              <button className="px-6 py-3 bg-blue-700 text-white rounded-xl shadow-lg hover:bg-blue-800 text-lg font-semibold transition-all duration-200 mb-8">
                Découvrir l’application
              </button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              <div className="bg-slate-900 p-6 rounded-xl shadow-md border-l-4 border-blue-500">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">🤖 Orchestrateur d'IA</h3>
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">🔔 Notifications Intelligentes</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">🗺️ Carte GPS Interactive</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">📈 Historique des Prix</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">🏆 Système de Gamification</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">♿ Accessibilité Renforcée</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="bg-slate-900 p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold mb-3 text-blue-300">💬 Feedback Utilisateur</h3>
                <ul className="text-sm text-slate-300 space-y-1">
            ...
            {/* Demo Actions + Features Summary dans le même parent */}
