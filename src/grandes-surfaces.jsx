...
function GrandesSurfacesApp() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <a href="/grandes-surfaces.html" className="text-sky-400 font-medium">Grandes Surfaces</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-sky-900/10 to-slate-800/20 backdrop-blur-sm py-12 border-b border-slate-700">
...
// Mount the app
const root = ReactDOM.createRoot(document.getElementById('grandes-surfaces-root'));
root.render(<GrandesSurfacesApp />);