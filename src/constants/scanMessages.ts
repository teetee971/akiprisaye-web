...
export const SCAN_MESSAGES = {
  ...
  permission: {
    ...
    denied: {
      ...
      description: "L'accès à la caméra est nécessaire pour scanner les codes-barres. Vous pouvez autoriser l'accès dans les paramètres ou utiliser les alternatives ci-dessous.",
      openSettings: "Voir comment activer"
    },
    notFound: {
      title: "Aucune caméra détectée",
      description: "Aucune caméra n'a été détectée sur cet appareil. Vous pouvez importer une image ou saisir le code manuellement."
    }
  },
  ...
  result: {
    ...
    productNotFound: {
      ...
      description: "Ce code-barres n'est pas encore dans notre base de données. Vous pouvez nous aider en ajoutant des informations sur ce produit.",
      actions: {
    ...
    failed: {
      ...
      description: "Nous n'avons pas réussi à lire le code-barres. Pas d'inquiétude, plusieurs alternatives sont disponibles.",
      actions: {
        retry: "Réessayer",
        upload: "Importer une image",
