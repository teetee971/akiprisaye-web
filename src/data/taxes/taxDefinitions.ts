...
export const TAX_DEFINITIONS: Record<string, TaxDefinition> = {
  ...
  droits_douane: {
    ...
    shortDescription: 'Taxes perçues sur les marchandises importées depuis l\'extérieur de l\'Union Européenne',
    officialRole: 'Protègent l\'économie européenne et génèrent des recettes pour le budget de l\'UE. Particulièrement pertinents pour les DOM éloignés des circuits d\'approvisionnement européens.',
    legalFramework: 'Code des douanes de l\'Union - Règlement (UE) n° 952/2013. Tarif douanier commun européen',
    knownLimitations: 'Les taux varient selon l\'origine des produits et leur catégorie. Des accords commerciaux peuvent réduire ou supprimer ces droits. L\'application peut différer selon les territoires ultramarins.',
    pedagogicalExample: 'Un produit électronique importé de Chine peut être soumis à des droits de douane de 5% à 14% selon sa catégorie, auxquels s\'ajoutent ensuite la TVA et l\'octroi de mer.',
  },
  tgap: {
    id: 'tgap',
    name: 'TGAP (Taxe Générale sur les Activités Polluantes)',
    shortDescription: 'Taxe environnementale sur les activités polluantes (déchets, émissions, carburants)',
    officialRole: 'Incite à réduire les pollutions et finance des actions environnementales. Appliquée notamment sur la mise en décharge de déchets et les émissions polluantes.',
    legalFramework: 'Code des douanes - Articles 266 sexies à 266 quaterdecies. Loi de finances',
    knownLimitations: 'Son application dans les DOM peut différer de la métropole en raison des spécificités locales de gestion des déchets et d\'énergie. Les taux peuvent être adaptés aux réalités territoriales.',
    pedagogicalExample: 'La TGAP sur les déchets enfouis peut représenter 50€ à 65€ par tonne, ce qui se répercute sur les coûts de produits générant beaucoup d\'emballages.',
  },
  contribution_audiovisuel: {
    id: 'contribution_audiovisuel',
    name: 'Contribution à l\'Audiovisuel Public',
    shortDescription: 'Contribution au financement de l\'audiovisuel public, intégrée dans certains équipements',
    officialRole: 'Finance les chaînes de télévision et radio publiques (France Télévisions, Radio France, Arte, INA)',
    legalFramework: 'Code général des impôts - Article 1605. Supprimée en métropole en 2022, maintenue sous d\'autres formes dans certains DOM',
    knownLimitations: 'Le mode de financement de l\'audiovisuel public a évolué. Dans les DOM, des dispositifs spécifiques peuvent s\'appliquer, notamment via France Télévisions et La 1ère.',
    pedagogicalExample: 'Historiquement intégrée dans les factures d\'électricité ou dans le prix de certains équipements audiovisuels, son montant était d\'environ 138€/an.',
  },
  taxe_soda: {
    id: 'taxe_soda',
    name: 'Taxe sur les Boissons Sucrées',
    shortDescription: 'Taxe sur les boissons contenant des sucres ajoutés ou édulcorants',
    officialRole: 'Objectif de santé publique visant à réduire la consommation de sucre et prévenir l\'obésité et le diabète, problématiques importantes dans les DOM',
    legalFramework: 'Code général des impôts - Article 1613 ter. Loi de financement de la Sécurité sociale',
    knownLimitations: 'Le taux varie selon la teneur en sucre. Les boissons avec édulcorants sont également concernées. L\'impact sanitaire dans les DOM justifie une attention particulière.',
    pedagogicalExample: 'Une boisson sucrée peut supporter une taxe de 7,53€ par hectolitre si elle contient plus de 8g de sucres par litre, soit environ 0,08€ par litre.',
  },
  taxe_alcool: {
    id: 'taxe_alcool',
    name: 'Droits d\'Accises sur les Alcools',
    shortDescription: 'Taxes sur les boissons alcoolisées (vins, bières, spiritueux)',
    officialRole: 'Double objectif de santé publique et de recettes fiscales. Les taux peuvent différer entre métropole et DOM.',
    legalFramework: 'Code général des impôts - Articles 402 bis à 520 A. Directives européennes sur les accises',
    knownLimitations: 'Les taux varient selon le type d\'alcool et le degré. Les productions locales (rhum des DOM) peuvent bénéficier de régimes spécifiques. Certaines exonérations existent pour les petits producteurs.',
    pedagogicalExample: 'Un litre de rhum à 40° peut supporter environ 15€ de droits d\'accises, soit plus de 50% du prix final. Le rhum produit dans les DOM bénéficie d\'exonérations partielles dans certains cas.',
  },
}
