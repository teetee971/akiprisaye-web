...
export function SelectProduit({ products = [], selected = null, onSelect }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label htmlFor="select-produit" className="block text-sm font-medium text-gray-700 mb-2">
      ...
      {selectedProduct && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-green-900 mb-3">Informations produit</h4>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-green-900">
                {selectedProduct.price_range.min.toFixed(2)} € -{' '}
                {selectedProduct.price_range.max.toFixed(2)} €
              </span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="mt-4 pt-4 border-t border-green-300">
            <p className="text-xs text-green-800">
              <strong>Note :</strong> Cette fourchette de prix est basée sur des observations
              ponctuelles et peut ne pas refléter l'ensemble des prix pratiqués.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
        <p className="text-xs text-gray-700">
          <strong>Règle de sécurité :</strong> Seuls les produits avec au moins {MIN_OBSERVATIONS}{' '}
