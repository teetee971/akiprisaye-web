...
const TERRITORY_LABELS: Record<string, string> = {
  gp: 'guadeloupe', mq: 'martinique', gf: 'guyane', re: 'la-reunion', yt: 'mayotte',
};

const DEFAULT_PRODUCTS = [
  'riz', 'lait', 'huile', 'sucre', 'farine', 'beurre',
  'yaourt', 'poulet', 'jambon', 'eau', 'coca-cola', 'pates',
];
...
export function generateKeywordGaps(
  ...
  return dedup.sort((a, b) =>
    b.priority - a.priority || a.keyword.localeCompare(b.keyword, 'fr'),
  );
}
