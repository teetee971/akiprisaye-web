...
export function InflationDashboard() {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg animate-pulse"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Nous ne pouvons pas afficher les données d'inflation pour le moment. Veuillez
  ...
  const avgInflation =
    metrics.territories.reduce((sum, t) => sum + t.overallInflationRate, 0) /
    metrics.territories.length;
  const avgMetropoleGap =
    metrics.territories.reduce((sum, t) => sum + (t.comparedToMetropole || 0), 0) /
    metrics.territories.length;
          ...
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-3">
                Comparaison des prix observés dans le territoire sélectionné par rapport à la
                référence métropole
              </p>
            </div>
            <button
          ...
          {showExplainer && (
            <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
              ...
              <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                <p>
                  <strong>Inflation globale :</strong> Représente l'évolution moyenne des prix
                  observés sur la période sélectionnée. Un taux de 3% signifie que les prix ont
                  augmenté de 3% en moyenne.
                </p>
                <p>
                  <strong>Écart métropole :</strong> Indique la différence de prix entre les
                  territoires d'Outre-mer et la métropole pour un panier de produits identiques.
                </p>
                <p>
                  <strong>Alertes actives :</strong> Nombre de territoires où l'inflation dépasse
                  5%, seuil considéré comme élevé nécessitant une vigilance particulière.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="relative group/tooltip">
                ...
                <div className="absolute right-0 top-8 hidden group-hover/tooltip:block w-64 bg-slate-900 dark:bg-slate-700 text-white text-xs rounded-lg p-3 shadow-xl z-10">
                  Ce pourcentage représente l'évolution moyenne des prix observés sur la période
                  sélectionnée
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-2 border-orange-500/20 hover:border-orange-500/40 transition-colors">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="relative group/tooltip">
                ...
                <div className="absolute right-0 top-8 hidden group-hover/tooltip:block w-64 bg-slate-900 dark:bg-slate-700 text-white text-xs rounded-lg p-3 shadow-xl z-10">
                  Différence de prix moyenne entre les DOM et la métropole pour des produits
                  identiques
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-2 border-red-500/20 hover:border-red-500/40 transition-colors">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="relative group/tooltip">
                ...
                <div className="absolute right-0 top-8 hidden group-hover/tooltip:block w-64 bg-slate-900 dark:bg-slate-700 text-white text-xs rounded-lg p-3 shadow-xl z-10">
                  Nombre de territoires où l'inflation dépasse 5%, seuil nécessitant une vigilance
                  accrue
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      ${
                        territory.overallInflationRate > 5
                          ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200'
                          : territory.overallInflationRate > 3
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-blue-100 text-sm">
                Identifiez quels produits contribuent le plus à la hausse des prix dans votre
                territoire
              </p>
            </div>
            <Link
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">
                Les taux d'inflation sont calculés à partir des observations de prix collectées par
                les citoyens et les sources officielles. Les données sont mises à jour
                quotidiennement et reflètent les variations réelles constatées sur le terrain.
              </p>
              <p className="text-xs text-slate-600 dark:text-slate-400">
                <strong>Méthodologie :</strong> Les prix sont comparés sur une base identique (même
                produit, même conditionnement) entre périodes et entre territoires pour garantir la
