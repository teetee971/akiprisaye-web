        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem', flexWrap: 'wrap' }}>
              <div>
                <div style={{ fontSize: '0.65rem', color: '#6366f1', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.3rem' }}>
                  🤖 {lettre.periode}
                </div>
              ...
              <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap' }}>
                {lettre.indicateurs.slice(0, 3).map((ind, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: '1.05rem', fontWeight: 900, color: '#a5b4fc', lineHeight: 1 }}>{ind.valeur}</div>
            ...
            {lettre.sections.slice(0, 2).map((s, i) => (
              <div key={i} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.35rem', flexWrap: 'wrap' }}>
                  ...
                  <span style={{ fontSize: '0.65rem', color: '#6366f1', fontWeight: 600, background: 'rgba(99,102,241,0.1)', padding: '1px 7px', borderRadius: 20, border: '1px solid rgba(99,102,241,0.25)' }}>
                    {s.territoire}
                  </span>
                </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.6rem', paddingTop: '0.5rem', borderTop: '1px solid rgba(148,163,184,0.1)' }}>
              ...
              <Link
                to="/lettre-hebdo"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', padding: '0.4rem 0.9rem', borderRadius: 7, background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.35)', color: '#a5b4fc', fontSize: '0.78rem', fontWeight: 700, textDecoration: 'none' }}
              >
          ...
          <div style={{ textAlign: 'center', padding: '2rem 1rem' }}>
            ...
            <Link
              to="/lettre-hebdo"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', padding: '0.45rem 1rem', borderRadius: 7, background: 'rgba(99,102,241,0.12)', border: '1px solid rgba(99,102,241,0.3)', color: '#a5b4fc', fontSize: '0.78rem', fontWeight: 600, textDecoration: 'none' }}
            >
              📬 Voir la page dédiée
            </Link>
          </div>
