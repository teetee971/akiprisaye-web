  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Système de gratification</h2>
        <p className="text-gray-400 text-sm">Reconnaissance d'usage (sobre)</p>
          ...
          return (
            <GlassCard
              ...
              className={`transition-all ${
                isEarned ? 'border-blue-500/50 bg-blue-900/20' : 'opacity-60 grayscale'
              }`}
            >
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 italic">{badge.criteria}</p>

                {isEarned && (
                  <div className="mt-3 pt-3 border-t border-blue-500/30">
                    <span className="text-xs text-blue-400 font-medium">✓ Obtenu</span>
                  </div>
                )}
              </div>
            </GlassCard>
      ...
      {showStats && (
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-white mb-4 text-center">Compteurs d'usage</h3>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <GlassCard className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Scans EAN réalisés</p>
            </GlassCard>
            ...
            <GlassCard className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Signalements utiles</p>
            </GlassCard>
            ...
            <GlassCard className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Exports open-data</p>
            </GlassCard>
            ...
            <GlassCard className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Utilisation régulière</p>
            </GlassCard>
          </div>
          ...
          <div className="mt-6 text-center">
            <GlassCard className="bg-green-900/20 border-green-500/30">
              <p className="text-base text-green-200 font-medium">💚 {getContributionMessage()}</p>
            </GlassCard>
          </div>
        </div>
      )}
          ...
          <div className="text-center">
            ...
            {earnedBadges.length > 0 && (
              <p className="text-xs text-gray-500 mt-2">
                {earnedBadges.length} badge{earnedBadges.length > 1 ? 's' : ''} obtenu
      ...
      <div className="text-center text-xs text-gray-500 mt-4">
        <p>Ces indications servent uniquement à contextualiser l'accès aux fonctionnalités.</p>
        <p className="mt-1">Elles ne constituent ni un classement, ni une distinction publique.</p>
      </div>
    </div>
  );
}
