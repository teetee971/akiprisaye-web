      ...
      {permissionState === 'denied' && (
        <div className="space-y-4">
          <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-700 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="font-bold text-red-900 dark:text-red-200 mb-1">Accès caméra refusé</p>
                <p className="text-sm text-red-800 dark:text-red-300">
                  L'accès à la caméra est nécessaire pour scanner les ingrédients. Vous pouvez
                  autoriser l'accès dans les paramètres ou importer une image.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {showInstructions && (
              <div
                className="rounded-lg bg-gray-50 dark:bg-slate-700 p-4 text-sm text-gray-800 dark:text-gray-200"
                role="note"
              >
