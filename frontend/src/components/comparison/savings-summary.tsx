  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-5">
        ...
        <div className="mt-4 p-3 bg-amber-900/20 border border-amber-700/50 rounded-lg">
          <p className="text-xs text-amber-200 flex items-start gap-2">
            <span>💡</span>
            <span>
              Ces projections supposent que vous faites des courses similaires chaque semaine.
              Les économies réelles peuvent varier selon vos habitudes d'achat et les prix en magasin.
            </span>
          </p>
        </div>
      </div>
      ...
      <div className="text-center text-xs text-gray-500">
        <p>
          💰 Comparer régulièrement peut vous aider à optimiser votre budget alimentaire
        </p>
      </div>
    </div>
  );
