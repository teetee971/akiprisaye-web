  ...
  return (
    <div className={`inline-flex flex-col items-center gap-2 ${className}`}>
      ...
      >
        ...
        <div className="absolute -bottom-1 -right-1 bg-white text-gray-900 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shadow-md border-2" style={{ borderColor: levelData.color }}>
          {level}
        </div>
      </div>
