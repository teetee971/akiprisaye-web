...
const STYLES: Record<SignalStatus, { card: string; sub: string }> = {
  buy:     { card: 'border-emerald-400/25 bg-emerald-400/10 text-emerald-300', sub: 'text-emerald-400/70' },
  wait:    { card: 'border-amber-400/25   bg-amber-400/10   text-amber-300',   sub: 'text-amber-400/70'   },
