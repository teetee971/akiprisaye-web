  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Prix au Kilo/Litre</h3>
        <button
          ...
          return (
            ...
            >
              <div className="flex-1">
                <strong className="block text-slate-900 dark:text-white">{product.name}</strong>
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-slate-500 dark:text-slate-400">par {unitLabel}</div>
