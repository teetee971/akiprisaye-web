 ...
 * @returns Total cost
 */
export function calculateTotalCost(basePrice: number, taxes: number[], fees: number[]): number {
 ...
 */
export function calculateSavings(currentPrice: number, bestPrice: number): Savings {
