...
const logisticsExplanations: LogisticsExplanation[] = [
  {
    ...
    explanatory_note:
      'Les produits frais nécessitent des conditions de transport spécifiques (chaîne du froid, rapidité) qui peuvent limiter les options logistiques disponibles. Leur acheminement dépend de la disponibilité de solutions adaptées.',
  },
  {
    ...
    sensitivity_level: 'élevée',
    explanatory_note:
      "Le transport de surgelés nécessite des équipements spécialisés en nombre limité. Les envois sont souvent groupés pour optimiser l'utilisation des conteneurs frigorifiques, ce qui peut allonger les délais d'attente avant départ.",
  },
  {
    ...
    explanatory_note:
      "Les produits volumineux sont généralement acheminés par voie maritime. Leur acheminement peut nécessiter d'attendre un groupage suffisant ou une rotation maritime programmée, ce qui explique des délais variables.",
  },
  {
    ...
    sensitivity_level: 'élevée',
    explanatory_note:
      'Les produits classés dangereux selon la réglementation ADR nécessitent des procédures spécifiques, des transporteurs certifiés et des contrôles renforcés. Ces exigences de sécurité peuvent allonger les délais de traitement et limiter les options de transport.',
  },
  {
    ...
    sensitivity_level: 'moyenne',
    explanatory_note:
      'Les pièces techniques sont souvent commandées à la demande et proviennent de réseaux de distribution spécialisés. Les délais dépendent du choix du mode de transport (aérien pour urgence, maritime pour optimisation) et de la disponibilité chez le fournisseur.',
  },
  {
    ...
    sensitivity_level: 'moyenne',
    explanatory_note:
      'Les produits saisonniers sont importés en volumes importants sur des périodes concentrées. Cette saisonnalité peut créer des saturations ponctuelles des chaînes logistiques, particulièrement lors des périodes de fêtes ou de rentrée scolaire.',
  },
  {
    ...
    explanatory_note:
      "Les produits à faible demande ne sont généralement pas stockés localement. Leur acheminement nécessite une commande spécifique et un groupage avec d'autres produits, ce qui peut allonger les délais mais permet de maintenir leur disponibilité.",
  },
  {
    ...
    sensitivity_level: 'élevée',
    explanatory_note:
      "Les produits de santé suivent des circuits logistiques spécifiques avec des exigences réglementaires strictes. Ces normes de sécurité et de traçabilité, essentielles pour la santé publique, peuvent influencer les délais d'acheminement.",
  },
];
...
export const generalDelayFactors = [
  {
    ...
    explanation:
      "Dans un même transport, certains produits peuvent être prioritaires (périssables, urgents) sur d'autres. Cette priorisation est un choix logistique standard.",
    applies_to: ['tous produits'],
  },
  {
    factor: 'Contraintes de stockage',
    explanation:
      "Les capacités de stockage (notamment frigorifique) sont limitées. Les flux sont organisés pour optimiser l'utilisation de ces espaces.",
    applies_to: ['frais', 'surgelés', 'volumineux'],
  },
  {
    factor: 'Normes spécifiques',
    explanation:
      'Certains produits doivent respecter des normes de transport particulières (température, sécurité, sanitaires) qui nécessitent des équipements et procédures spécialisés.',
    applies_to: ['frais', 'surgelés', 'dangereux', 'pharmaceutiques'],
  },
  {
    factor: 'Mutualisation des flux',
    explanation:
      "Pour optimiser l'utilisation des transports, les produits peuvent être groupés. Cela nécessite parfois d'attendre un volume suffisant avant expédition.",
    applies_to: ['volumineux', 'faible rotation', 'pièces détachées'],
  },
  {
    factor: 'Dépendance à un seul mode de transport',
    explanation:
      'Certains produits ne peuvent être acheminés que par un mode de transport spécifique (maritime pour volumineux, aérien pour ultra-frais), ce qui limite les alternatives.',
    applies_to: ['volumineux', 'frais', 'surgelés'],
  },
  {
    factor: 'Contraintes locales',
    explanation:
      "Les infrastructures locales (portuaires, aéroportuaires, routières, frigorifiques) ont des capacités définies qui influencent l'organisation des flux.",
    applies_to: ['tous produits'],
  },
];
