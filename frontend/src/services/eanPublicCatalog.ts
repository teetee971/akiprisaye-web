...
const LOCAL_CATALOG: PublicProduct[] = [
  {
    ...
    observedPrices: [
      ...
      { territory: 'MQ', store: 'Épicerie B', price: 6.5, date: '2025-11-18T10:00:00Z' },
    ],
  ...
  },
  {
    ...
    territories: ['GP', 'RE'],
    observedPrices: [
      { territory: 'GP', store: 'Supermarché A', price: 2.5, date: '2025-11-22T10:00:00Z' },
    ],
  ...
  },
  {
    ...
    territories: ['GP', 'MQ', 'RE'],
    observedPrices: [
      { territory: 'RE', store: 'Carrefour', price: 1.2, date: '2025-11-25T10:00:00Z' },
  ...
  },
  {
    ...
    observedPrices: [
      ...
      { territory: 'MQ', store: 'Test Store 2', price: 4.2, date: '2025-01-05T10:00:00Z' },
    ],
