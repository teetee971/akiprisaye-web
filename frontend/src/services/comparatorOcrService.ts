...
import type { OCRResult, InvoiceParsed, ReceiptParsed } from '../types/comparatorCommon';
 ...
 */
export function validateOCRResult(result: OCRResult, minConfidence: number = 60): boolean {
  return result.text.length > 0 && result.confidence >= minConfidence;
}
