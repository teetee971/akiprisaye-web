...
const mockStableObservations: PricePoint[] = [
  ...
  { date: '2025-11-22T10:00:00Z', price: 2.5 },
  { date: '2025-11-29T10:00:00Z', price: 2.5 },
];

const mockVolatileObservations: PricePoint[] = [
  { date: '2025-11-01T10:00:00Z', price: 2.5 },
  { date: '2025-11-08T10:00:00Z', price: 3.0 },
  { date: '2025-11-15T10:00:00Z', price: 2.2 },
  { date: '2025-11-22T10:00:00Z', price: 2.8 },
  { date: '2025-11-29T10:00:00Z', price: 2.4 },
];

describe('predictivePricingService', () => {
  describe('predictPriceChange', () => {
    it('should return low confidence for insufficient data', () => {
      const result = predictPriceChange([{ date: '2025-11-01T10:00:00Z', price: 2.5 }]);
