 ...
 */
export function isValidAuthTransition(from: AuthFlowState, to: AuthFlowState): boolean {
 ...
 */
export function nextAuthFlowState(current: AuthFlowState, next: AuthFlowState): AuthFlowState {
 ...
 */
export function shouldShowAuthSkeleton(state: AuthFlowState, loading: boolean): boolean {
 ...
 */
export function shouldRedirectAuthenticatedUser(state: AuthFlowState, hasUser: boolean): boolean {
