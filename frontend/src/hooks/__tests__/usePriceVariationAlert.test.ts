...
describe('usePriceVariationAlert', () => {
  ...
  it('should return no alert for single price point', () => {
    const prices: PricePoint[] = [{ value: 5.99, date: '2026-01-01T00:00:00Z' }];
  ...
  it('should return no alert for variation below 15% threshold', () => {
    const prices: PricePoint[] = [
      { value: 6.0, date: '2026-01-01T00:00:00Z' },
      { value: 6.5, date: '2026-01-02T00:00:00Z' }, // +8.3% variation
    ];
  ...
  it('should trigger upward alert for +15% variation', () => {
    const prices: PricePoint[] = [
      { value: 6.0, date: '2026-01-01T00:00:00Z' },
      { value: 6.9, date: '2026-01-02T00:00:00Z' }, // +15% variation
    ];
  ...
  it('should trigger downward alert for -15% variation', () => {
    const prices: PricePoint[] = [
      { value: 6.0, date: '2026-01-01T00:00:00Z' },
      { value: 5.1, date: '2026-01-02T00:00:00Z' }, // -15% variation
    ];
  ...
  it('should trigger upward alert for significant price increase (+20%)', () => {
    const prices: PricePoint[] = [
      { value: 5.0, date: '2026-01-01T00:00:00Z' },
      { value: 6.0, date: '2026-01-02T00:00:00Z' }, // +20% variation
    ];
  ...
  it('should trigger downward alert for significant price decrease (-25%)', () => {
    const prices: PricePoint[] = [
      { value: 8.0, date: '2026-01-01T00:00:00Z' },
      { value: 6.0, date: '2026-01-02T00:00:00Z' }, // -25% variation
    ];
  ...
  it('should calculate variation against average of previous prices', () => {
    const prices: PricePoint[] = [
      { value: 5.0, date: '2026-01-01T00:00:00Z' },
      { value: 6.0, date: '2026-01-02T00:00:00Z' },
      { value: 7.0, date: '2026-01-03T00:00:00Z' },
  ...
  it('should handle unsorted dates correctly', () => {
    const prices: PricePoint[] = [
      { value: 6.0, date: '2026-01-03T00:00:00Z' }, // Middle date
      { value: 5.0, date: '2026-01-01T00:00:00Z' }, // Earliest date
      { value: 7.5, date: '2026-01-05T00:00:00Z' }, // Latest date (+36% from avg 5.5)
    ];
  ...
  it('should handle very large price increases', () => {
    const prices: PricePoint[] = [
      { value: 5.0, date: '2026-01-01T00:00:00Z' },
      { value: 15.0, date: '2026-01-02T00:00:00Z' }, // +200% variation
    ];
  ...
  it('should handle very large price decreases', () => {
    const prices: PricePoint[] = [
      { value: 10.0, date: '2026-01-01T00:00:00Z' },
      { value: 2.0, date: '2026-01-02T00:00:00Z' }, // -80% variation
    ];
  ...
  it('should work with multiple historical prices', () => {
    const prices: PricePoint[] = [
      { value: 5.0, date: '2026-01-01T00:00:00Z' },
      { value: 5.1, date: '2026-01-02T00:00:00Z' },
      { value: 5.2, date: '2026-01-03T00:00:00Z' },
      { value: 5.05, date: '2026-01-04T00:00:00Z' },
      { value: 5.15, date: '2026-01-05T00:00:00Z' },
      { value: 6.0, date: '2026-01-06T00:00:00Z' }, // Average: 5.10, Latest: 6.00 = +17.6%
    ];
  ...
  it('should handle exact 15% threshold (boundary test)', () => {
    const prices: PricePoint[] = [
      { value: 10.0, date: '2026-01-01T00:00:00Z' },
      { value: 11.5, date: '2026-01-02T00:00:00Z' }, // Exactly +15%
    ];
  ...
  it('should handle exact -15% threshold (boundary test)', () => {
    const prices: PricePoint[] = [
      { value: 10.0, date: '2026-01-01T00:00:00Z' },
      { value: 8.5, date: '2026-01-02T00:00:00Z' }, // Exactly -15%
    ];
