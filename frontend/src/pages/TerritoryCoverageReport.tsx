  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://teetee971.github.io/akiprisaye-web/couverture-territoires"
        />
        <link
          rel="alternate"
          hrefLang="fr"
            ...
            <div className="mb-6 grid grid-cols-3 gap-3">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700 text-center shadow-sm">
                <p className="text-2xl font-bold text-blue-600">
                  {covered}/{ALL_TERRITORIES.length}
                </p>
              ...
              {reports.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`absolute inset-0 w-32 bg-gradient-to-r ${terrGradient} opacity-10 pointer-events-none`}
                    />
                      ...
                      {r.categories.length > 0 && (
                        <div className="mt-2 flex flex-wrap gap-1.5">
                          {r.categories.map((c) => (
                            <span
                              key={c}
                              className="inline-flex px-2 py-0.5 rounded text-xs bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300"
                            >
                              {c}
                            </span>
                          ))}
...
function FreshnessBadge({
  ...
  status: TerritoryReport['freshness'];
  latest: string | null;
}) {
  if (status === 'fresh')
    return (
