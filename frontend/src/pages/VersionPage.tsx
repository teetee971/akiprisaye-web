      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Comparez le SHA ci-dessous avec le dernier commit sur GitHub pour confirmer que le site
            sert bien la dernière version.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4 text-sm space-y-2">
          ...
          <ol className="text-slate-500 space-y-1 list-decimal list-inside">
            ...
            <li>
              SHA ici <span className="text-emerald-400">==</span> SHA GitHub → ✅ déploiement
              validé
            </li>
          </ol>
        </div>
