...
export function ExecutiveDashboardPage() {
  ...
  useEffect(() => {
    ...
    const healthRaw = Math.min(100, Math.round(
    ...
    setKpis([
      ...
      { name: 'CTR',             value: `${ctrPct}%`,       unit: '',  trend: ctrPct >= 5 ? 'up' : ctrPct > 0 ? 'stable' : 'down' },
      { name: 'Favoris ajoutés', value: k.favoritesAdded,  trend: k.favoritesAdded > 0 ? 'up' : 'stable' },
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white px-4 py-6 max-w-3xl mx-auto">
      ...
      <p className="text-gray-400 text-sm mb-6">KPIs live · alertes stratégiques · backlog décisions</p>
