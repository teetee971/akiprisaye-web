      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-blue-900 text-blue-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">1</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-purple-900 text-purple-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">2</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-green-900 text-green-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">3</span>
          ...
          <div className="bg-green-950/30 p-4 rounded">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Le prix barré doit avoir été appliqué récemment (dans les 30 jours)</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">•</span>
                <span className="text-gray-300">Il doit s'agir du prix le plus bas de cette période</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">•</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-indigo-900 text-indigo-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">4</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-orange-900 text-orange-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">5</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-teal-900 text-teal-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">6</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-red-900 text-red-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">7</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-yellow-900 text-yellow-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">8</span>
          ...
          <div className="space-y-4">
            {interpretationErrors.map((error) => (
              <div key={error.id} className="bg-yellow-950/30 p-4 rounded">
                <p className="font-semibold text-yellow-200 mb-2"><span role="img" aria-label="Erreur">❌</span> {error.error_type}</p>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-cyan-900 text-cyan-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">9</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-gray-800 text-gray-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">10</span>
          ...
          <div className="space-y-4">
            {promotionExamples.map((promo) => (
              <div key={promo.id} className={`p-4 rounded border-l-4 ${
                promo.is_genuine ? 'bg-green-950/30 border-green-500' : 'bg-orange-950/30 border-orange-500'
              }`}>
                <div className="flex items-start justify-between mb-2">
                  <h3 className="font-semibold text-gray-100">{promo.description}</h3>
                  <span className={`text-xs px-2 py-1 rounded ${
                    promo.is_genuine ? 'bg-green-900/50 text-green-300' : 'bg-orange-900/50 text-orange-300'
                  }`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-3">
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-100"><del title="Prix barré">{promo.regular_price.toFixed(2)} €</del></p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">Prix promotionnel</p>
                    <p className="text-xl font-bold text-gray-100">{promo.promotional_price.toFixed(2)} €</p>
                  </div>
                </div>

                <div className="mb-3">
                  <p className="text-sm text-gray-400">Réduction affichée</p>
                  <p className="text-lg font-semibold text-gray-100">{promo.discount_percentage}%</p>
                </div>

                <div className="mb-3">
                  <p className="text-sm text-gray-400">Période (fictive)</p>
                  <p className="text-gray-100">Du {promo.start_date} au {promo.end_date}</p>
                </div>
