      ...
      <div className="min-h-screen bg-slate-950 pb-12">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white px-4 py-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-purple-100 text-sm">Logistique dans les territoires ultramarins</p>
          </div>
        </div>
          ...
          <div className="bg-purple-950/30 border-l-4 border-purple-500 p-4 rounded-r-lg">
            <div className="flex items-start">
              ...
              <div className="text-sm text-purple-200">
                ...
                <p className="mt-2">
                  <strong>
                    Les réponses sont descriptives, pédagogiques et ne constituent ni une analyse
                    économique, ni une attribution de responsabilité.
                  </strong>
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 space-y-3">
          ...
          {displayedQuestions.map((item) => (
            <div
              key={item.id}
              className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 overflow-hidden"
            >
              {/* Question (cliquable) */}
              <button
              ...
              >
                <div className="flex-1 pr-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-100 text-sm mb-1">{item.question}</h3>
                      {searchQuery && (
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-6">
            <h2 className="text-lg font-bold text-gray-100 mb-4">Pour aller plus loin</h2>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-400">Comprendre les termes logistiques</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  <span className="text-2xl mr-3">📊</span>
                  <div>
                    <h3 className="font-semibold text-purple-200 text-sm">Indice Logistique DOM</h3>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-400">Explications par catégorie de produit</p>
                  </div>
                </div>
                <ExternalLink className="w-4 h-4 text-purple-400" />
              </Link>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-6">
            <h2 className="text-lg font-bold text-gray-100 mb-4">À propos de cette FAQ</h2>

            <div className="space-y-3 text-sm text-gray-300">
              <div>
                <h3 className="font-semibold text-gray-100 mb-2">Objectif</h3>
                <p>
                  Cette FAQ vise à apporter des <strong>réponses claires et pédagogiques</strong>{' '}
                  aux questions fréquemment posées par les citoyens sur la logistique vers les
              ...
              <div>
                ...
                <p>
                  Les réponses sont <strong>descriptives et neutres</strong>. Elles expliquent des
                  mécanismes logistiques sans porter de jugement, sans analyser les prix et sans
                  attribuer de responsabilités.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Cette FAQ présente des <strong>explications générales</strong>. Les situations
                  concrètes peuvent varier selon de nombreux facteurs. Ces réponses ne constituent
                  ni des conseils, ni des analyses économiques.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="bg-slate-800/50 rounded-lg p-4 text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Réponses pédagogiques • Aucune analyse économique • Aucune attribution de
              responsabilité • Neutralité absolue
            </p>
          </div>
        </div>
      </div>
