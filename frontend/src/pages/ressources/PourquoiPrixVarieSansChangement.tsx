  ...
  return (
    <div className="min-h-screen bg-slate-950 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-blue-900 text-blue-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">2</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-orange-900 text-orange-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">4</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-purple-900 text-purple-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">5</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-indigo-900 text-indigo-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">6</span>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-yellow-900 text-yellow-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">7</span>
          ...
          <div className="space-y-3">
            <div className="bg-yellow-950/30 border-l-4 border-yellow-500 p-4">
              ...
              <p className="text-sm text-gray-300">Un prix du 5 mars ne peut pas être comparé à un prix du 20 avril sans tenir compte du temps écoulé.</p>
            </div>
            <div className="bg-yellow-950/30 border-l-4 border-yellow-500 p-4">
              <p className="font-semibold text-gray-100 mb-1">Prix entre territoires différents</p>
              <p className="text-sm text-gray-300">Les contextes locaux varient (logistique, taxes, approvisionnement).</p>
            </div>
            <div className="bg-yellow-950/30 border-l-4 border-yellow-500 p-4">
              <p className="font-semibold text-gray-100 mb-1">Prix hors périodes promotionnelles</p>
              <p className="text-sm text-gray-300">Une promotion temporaire modifie le prix observé sans que cela reflète une variation structurelle.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-red-900 text-red-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">8</span>
            Erreurs fréquentes d'interprétation
          </h2>
          
          <div className="space-y-4">
            <div className="bg-red-950/30 p-4 rounded">
              <p className="font-semibold text-red-200 mb-2">❌ Erreur 1 : Attribuer une cause unique</p>
            ...
            <div className="bg-red-950/30 p-4 rounded">
              <p className="font-semibold text-red-200 mb-2">❌ Erreur 2 : Généraliser à partir d'un cas</p>
              <p className="text-sm text-gray-300">
            ...
            <div className="bg-red-950/30 p-4 rounded">
              <p className="font-semibold text-red-200 mb-2">❌ Erreur 3 : Anticiper automatiquement</p>
              <p className="text-sm text-gray-300">
            ...
            <div className="bg-red-950/30 p-4 rounded">
              <p className="font-semibold text-red-200 mb-2">❌ Erreur 4 : Utiliser des termes de jugement</p>
              <p className="text-sm text-gray-300">
        ...
        <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-6 mb-6">
          <h2 className="text-2xl font-bold text-gray-100 mb-4 flex items-center">
            <span className="bg-gray-800 text-gray-300 rounded-full w-8 h-8 flex items-center justify-center mr-3 text-sm font-bold">9</span>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-800/50 p-4 rounded">
              <p className="font-semibold text-gray-100 mb-2">✗ Ce que ne fait pas l'observatoire</p>
              <ul className="space-y-1 text-sm text-gray-300">
