        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <Card className="p-8 print:shadow-none print:border-2 print:border-gray-300">
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">📰 Titre</h3>
                <p className="text-xl font-semibold text-gray-800 leading-relaxed">
                  A KI PRI SA YÉ lance un observatoire citoyen des prix pour mieux comprendre la vie
                  chère dans les territoires ultramarins
                </p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">🗓️ Date / Lieu</h3>
                <p className="text-gray-700">Guadeloupe, {currentDate}</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">✍️ Corps du communiqué</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    <strong>A KI PRI SA YÉ</strong> met en ligne un observatoire citoyen des prix
                    destiné à rendre plus lisible l'évolution du coût de la vie dans les territoires
                    ultramarins.
                  </p>
                  <p>
                  ...
                  <p>
                    L'ensemble des données est publié en open data, sans collecte de données
                    personnelles, sans publicité et sans système de notation.
                  </p>
                  <p>
                    <strong>A KI PRI SA YÉ</strong> se positionne comme un outil citoyen,
                    indépendant et transparent, au service du débat public, des collectivités, des
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">📌 Mentions importantes</h3>
          ...
          <Card className="p-8 print:shadow-none print:border-2 print:border-gray-300 print:break-before-page">
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 print:bg-gray-50 border-l-4 border-blue-600 p-6 rounded">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Citation institutionnelle</h3>
                <blockquote className="text-xl italic text-gray-800">
              ...
              <div className="bg-blue-50 print:bg-gray-50 border-l-4 border-blue-600 p-6 rounded">
                <h3 className="text-lg font-bold text-gray-900 mb-3">Citation pédagogique</h3>
                <blockquote className="text-xl italic text-gray-800">
                  « L'observatoire repose sur des méthodes simples, ouvertes et auditées. Chacun
                  peut vérifier les données. »
                </blockquote>
              </div>
            </div>
          </Card>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-700">Outre-mer (périmètre précisé sur le site)</p>
                </div>
              </div>
