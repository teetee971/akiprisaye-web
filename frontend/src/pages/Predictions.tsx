          ...
          <GlassCard>
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-green-400">
                {getStatusCount('baisse_probable')}
              </div>
            </div>
          </GlassCard>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <select
                ...
                value={statusFilter}
                onChange={(e) =>
                  setStatusFilter(e.target.value as PredictionScore['status'] | 'all')
                }
              ...
              >
                ...
                <option value="baisse_probable" className="bg-gray-800">
                  Baisse probable
                </option>
                <option value="surveillance" className="bg-gray-800">
                  Surveillance
                </option>
                <option value="stable" className="bg-gray-800">
                  Stable
                </option>
              </select>
            </div>
                ...
                <GlassCard key={`${pred.productId}-${idx}`}>
                  <div className="flex flex-col md:flex-row gap-4 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-white/70 mb-2">{pred.prediction.justification}</p>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                        <div>
                          ...
                          <span
                            className={`ml-1 font-medium ${pred.prediction.metrics.trend < 0 ? 'text-green-400' : 'text-red-400'}`}
                          >
                        ...
                        <div>
                          ...
                          <span
                            className={`ml-1 font-medium ${pred.prediction.metrics.acceleration < 0 ? 'text-green-400' : 'text-white/80'}`}
                          >
                        ...
                        <div>
                          ...
                          <span
                            className={`ml-1 font-medium ${pred.prediction.metrics.lastChangePercentage < 0 ? 'text-green-400' : 'text-red-400'}`}
                          >
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <Sparkline
                        ...
                        height={50}
                        stroke={
                          pred.prediction.status === 'baisse_probable'
                            ? '#4ade80'
                            : pred.prediction.status === 'surveillance'
                              ? '#fb923c'
                              : '#60a5fa'
                        }
                      />
                      <div className="text-xs text-white/50">{pred.observations.length} obs.</div>
                    </div>
                  </div>
                </GlassCard>
              );
