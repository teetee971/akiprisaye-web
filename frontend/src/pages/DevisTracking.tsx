    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow p-8 max-w-sm w-full text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">Connectez-vous pour accéder à vos devis.</p>
          <Link
            to="/login"
    ...
    <>
      ...
      >
        ...
        <p style={{ margin: '0.25rem 0 0', fontSize: '0.85rem', color: 'rgba(255,255,255,0.75)' }}>
          Suivez l'avancement de vos devis
        </p>
      </HeroImage>
            ...
            <div className="flex-1 min-w-0 space-y-4">
                      ...
                      return (
                        <div key={step.status} className="flex items-center flex-1">
                          <div className="flex flex-col items-center">
                            ...
                            <span
                              className={`text-xs mt-1 text-center ${active ? 'text-indigo-700 font-semibold' : 'text-gray-400'}`}
                            >
                              {step.label}
                            </span>
                          </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                  <Row
                    label="Type"
                    value={CLIENT_TYPE_LABELS[selected.clientType] ?? selected.clientType}
                  />
                ...
                <div className="bg-white border border-green-200 rounded-xl p-5">
                  ...
                  {selected.status === 'SENT' && (
                    <>
                      ...
                      <p className="text-xs text-gray-500 mt-2 text-center">
                        L'acceptation constitue un engagement contractuel. Le paiement sera traité
                        séparément.
                      </p>
                    </>
                  )}
                  ...
                  {selected.status === 'ACCEPTED' && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800 flex gap-2">
                      ...
                      Devis accepté. Votre contact prendra en charge le règlement selon les
                      modalités convenues.
                    </div>
                  )}
                </div>
