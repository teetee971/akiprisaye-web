  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
          ...
          <p className="text-xs text-blue-700 dark:text-blue-500 mt-1">
            Accès aux prix, produits, territoires
          </p>
        </div>
        <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-4">
          ...
          <p className="text-xs text-purple-700 dark:text-purple-500 mt-1">
            + Export, Webhooks, Analytics avancées
          </p>
        </div>
      </div>
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
        ...
        {activeKeys.length === 0 ? (
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Aucune clé active. Générez votre première clé ci-dessous.
          </p>
        ) : (
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
        ...
        <p className="mt-2 text-xs text-orange-600 dark:text-orange-400">
          ⚠ La clé complète n'est visible qu'une seule fois après génération. Copiez-la
          immédiatement.
        </p>
      </section>
    </div>
