...
const ADMIN_LINKS: AdminLink[] = [
  { label: 'Dashboard Admin',       icon: BarChart3,   to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Gestion utilisateurs',  icon: Users,       to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Sync / Import',         icon: RefreshCw,   to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Gestion Magasins',      icon: Building2,   to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Gestion Produits',      icon: Database,    to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Import Prix',           icon: Download,    to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Modération',            icon: Shield,      to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Marketplace Admin',     icon: Globe,       to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  { label: 'Devis Institutionnels', icon: FileText,    to: '/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
...
const SETUP_STEPS: Step[] = [
  ...
  {
    num: 2,
    title: 'Installez firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
    detail: 'Dans un terminal, à la racine du projet, lancez l\'installation des dépendances (firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
    code: 'npm install',
  },
  {
    num: 3,
    title: 'Téléchargez la clé Admin Firebase',
    detail: 'Compte de service : firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
    code: 'akiprisaye-web/\n├── firebase.json\n├── package.json\n├── serviceAccountKey.json   ← 👈 ICI\n├── frontend/\n└── scripts/',
    link: { label: 'Firebase Console → Comptes de service →', href: 'https://console.firebase.google.com/project/a-ki-pri-sa-ye/settings/serviceaccounts/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  },
  {
    num: 4,
  ...
  },
  {
    ...
    detail: 'Ce tableau de bord confirme votre statut. Toutes les fonctionnalités admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  },
];
...
const TERMUX_STEPS: MobileStep[] = [
  ...
  {
    num: 4,
    title: 'Installer firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
    ...
    code: 'npm install firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  },
];
...
const EspaceCreateur: React.FC = () => {
  ...
  // isCreator is true for both "creator" and "admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
  if (!isCreator) {
      ...
      <div className="max-w-5xl mx-auto px-4 pt-4 pb-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-amber-200/70 text-sm mt-1">
                Développeur & fondateur — Toutes les fonctionnalités débloquées, quotas infinis, accès admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
              </p>
            </div>
        ...
        <section className="mb-8 order-1 md:order-2">
          <h2 className="mb-3 flex items-center gap-2 text-base font-bold text-white sm:mb-4 sm:text-lg">
            ...
            Outils d'admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
          </h2>
          <div className="mb-3 rounded-2xl border border-slate-700/50 bg-slate-900/60 p-3.5 sm:mb-4 sm:p-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <p className="text-sm font-semibold text-white">
                  {(userRole === 'admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                    ? 'Votre rôle créateur/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                    : 'Ces modules système nécessitent un compte créateur ou admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                </p>
                <p className="mt-1 text-xs leading-relaxed text-slate-400">
                  {(userRole === 'admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                    ? 'Chaque pavé ouvre directement le bon écran d’admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                    : 'Une fois le rôle créateur/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 sm:gap-3 lg:grid-cols-3">
            {ADMIN_LINKS.map(l => {
              ...
              // (accessible to both `admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
              const requiresInternalAccess = l.requiresAdmin;
              const isLocked = requiresInternalAccess && userRole !== 'admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-slate-300">
                    {selectedAdminLink.description}. Ce module pointe bien vers <code className="rounded bg-slate-950/70 px-1.5 py-0.5 text-xs text-amber-200">{selectedAdminLink.to}</code>, mais la route est volontairement réservée au rôle <strong>admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                  </p>
                  <ul className="mt-3 space-y-1 text-xs text-slate-400">
                    <li>• Rôle actuel : <span className="font-semibold text-amber-200">{userRole}</span></li>
                    <li>• Action recommandée : promouvoir le compte en <span className="font-semibold text-emerald-300">admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
              ...
              <div>
                ...
                <div className="mb-4 bg-green-950/40 border border-green-600/40 rounded-xl p-3">
                  ...
                  {[
                    ...
                    { cmd: 'npm install firebase-admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
                  ].map(({ cmd, note }) => (
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link to="/admin<br /><span style={{color: '#10b981', fontSize: '0.75em', fontWeight: 'bold'}}>📡 Radar Actif : Collecte Géo + Sessions</span><div style={{fontSize: '0.7em', opacity: 0.8, marginTop: '8px', padding: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', borderLeft: '2px solid #fbbf24'}}>• Dernière : 27/03 à 09:10 (FINAL_FIX)<br/>• Précédente : 27/03 à 08:40 (TOTAL_CLEAN)</div>
