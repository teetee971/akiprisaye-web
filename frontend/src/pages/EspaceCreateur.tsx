...
const SETUP_STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: 'Console Firebase → Paramètres du projet → Comptes de service → "Générer une nouvelle clé privée". Placez le fichier JSON à la racine du projet.',
    link: { label: 'Firebase Console →', href: 'https://console.firebase.google.com/project/a-ki-pri-sa-ye/settings/serviceaccounts/adminsdk' },
  },
  {
    num: 3,
