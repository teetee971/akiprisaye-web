    ...
    <>
      <Helmet>
        ...
        <link
          rel="alternate"
          hrefLang="fr"
          href="https://teetee971.github.io/akiprisaye-web/recherche-prix"
        />
        <link
          rel="alternate"
          hrefLang="x-default"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {searchMode === 'receipt' ? (
            ...
            <>
              ...
              <div className="mb-6 animate-fade-in">
                ...
                >
                  ...
                  <p className="text-slate-300 text-sm drop-shadow">
                    Recherche par nom, code-barres, photo ou ticket de caisse
                  </p>
                </HeroImage>
              </div>
              ...
              <div
                className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 ${showQuickScan ? 'opacity-50 pointer-events-none' : ''}`}
              >
                {/* 1. Text Search */}
                <button
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-center mb-1">🔎 Nom du produit</h3>
                  <p className="text-xs text-gray-400 text-center">Recherche par texte</p>
                </button>
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-center mb-1">📦 Code-barres</h3>
                  <p className="text-xs text-gray-400 text-center">Scanner EAN/UPC</p>
                </button>
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-center mb-1">📸 Photo produit</h3>
                  <p className="text-xs text-gray-400 text-center">Recherche par image</p>
                </button>
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-center mb-1">🧾 Ticket de caisse</h3>
                  <p className="text-xs text-gray-400 text-center">Analyse complète</p>
                </button>
              </div>
              ...
              <div className="glass-card p-6 border border-blue-500/30 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">Outil d'information citoyenne</h3>
