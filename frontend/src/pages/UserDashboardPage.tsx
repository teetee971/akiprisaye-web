...
import { RecentPriceDropsSection, type PriceDrop } from '../components/user/RecentPriceDropsSection';
  ...
  const priceDrops: PriceDrop[] = useMemo(() =>
    topDeals
      ...
      .map((p) => ({
        ...
        previousPrice: p.price != null && p.priceDrop ? p.price / (1 - p.priceDrop) : (p.price ?? 0),
        retailer:      p.retailer,
        delta:         p.priceDrop ?? 0,
