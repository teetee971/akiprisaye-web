      ...
      <GlassContainer className="max-w-6xl mx-auto p-8">
        ...
        >
          <h1 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 900, color: '#fff' }}>
            🏛️ Licence Institutionnelle
          </h1>
          <p
            style={{ margin: '0.25rem 0 0', fontSize: '0.85rem', color: 'rgba(255,255,255,0.75)' }}
          >
            Licence d'accès pour institutions et collectivités territoriales
          </p>
        </HeroImage>
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-12">
          ...
          <GlassCard>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="pt-4 border-t border-white/[0.22]">
                ...
                <p className="text-sm">
                  France hexagonale + 12 territoires DOM-ROM-COM (Guadeloupe, Martinique, Guyane, La
                  Réunion, Mayotte, Saint-Pierre-et-Miquelon, Saint-Barthélemy, Saint-Martin,
                  Wallis-et-Futuna, Polynésie française, Nouvelle-Calédonie, Terres australes
                  françaises)
                </p>
              </div>
            </div>
          ...
          <GlassCard>
            ...
            <div className="space-y-4 text-gray-300">
              <p className="font-semibold text-white">100% de données publiques officielles</p>

              <div className="space-y-3">
                <div className="p-3 bg-white/[0.05] rounded-lg">
                  <div className="font-semibold text-white mb-1">INSEE</div>
                  <div className="text-sm">
                    Statistiques démographiques, économiques et territoriales
                  </div>
                </div>
            ...
            <div className="pt-4 border-t border-white/[0.22]">
              ...
              <LimitNote>
                <ul className="space-y-2">
                  <li>
                    <strong>Exhaustivité</strong>: Les données dépendent de la complétude des
                    sources publiques
                  </li>
                  <li>
                    <strong>Actualité</strong>: Délai de publication variable selon les sources
                    (voir badges de date)
                  </li>
                  <li>
                    <strong>Précision</strong>: Les données sont des moyennes territoriales, pas des
                    prix exacts
                  </li>
                  <li>
                    <strong>Usage</strong>: Outil d'aide à la décision, ne constitue pas un conseil
                    commercial
                  </li>
                </ul>
              </LimitNote>
        ...
        <GlassCard className="mb-12">
          ...
          <div className="space-y-4 text-gray-300">
            <div className="p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2 text-sm">
                <li>
                  <strong>Utilisateurs institutionnels</strong>: Email, nom de l'organisme,
                  territoire principal
                </li>
                <li>
                  <strong>Pas de géolocalisation stockée</strong>: Utilisation locale uniquement
                  (navigateur)
                </li>
                <li>
                  <strong>Pas de tracking comportemental</strong>: Aucun cookie publicitaire ou
                  analytics tiers
                </li>
                <li>
                  <strong>Stockage local prioritaire</strong>: Les listes et préférences restent sur
                  l'appareil
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-gray-300">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="text-3xl font-bold text-blue-400 mb-2">500 € - 50 000 € / an</div>
                <p className="text-sm">
                  Tarification adaptée au périmètre, à la taille de l'organisme et au volume
                  d'utilisation.
                </p>
              </div>
            ...
            <div className="pt-4 border-t border-blue-500/30">
              <p className="text-sm">
                <strong className="text-white">Transparence tarifaire</strong>: Devis détaillé
                fourni après analyse du besoin. Aucun frais caché. Facturation annuelle. Résiliation
                possible avec préavis de 3 mois.
              </p>
            </div>
          </div>
        </GlassCard>
        ...
        <div className="mb-8">
          <DataBadge
            source="INSEE · OPMR · DGCCRF · data.gouv.fr · SIRENE · OpenStreetMap"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <GlassCard className="border-blue-500/50">
            <div className="text-center">
              ...
              <CivicButton
                ...
                onClick={() =>
                  toast(
                    'Dossier institutionnel en cours de génération. Contact : institutions@akiprisaye.fr',
                    { icon: '📄', duration: 5000 }
                  )
                }
              >
          ...
          <GlassCard className="border-green-500/50">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm mb-6">
                Notre équipe vous accompagne dans l'analyse de vos besoins et l'établissement d'un
                devis sur mesure
              </p>
              <CivicButton
                variant="primary"
