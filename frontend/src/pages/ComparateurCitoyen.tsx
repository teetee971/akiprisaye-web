...
export default function ComparateurCitoyen() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      if (!successfulFile) {
        const errorMessage =
          "Impossible de charger les données de l'observatoire. Tous les fichiers de données sont indisponibles.";
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Error State */}
          {error && !loading && (
            <ErrorState error={error} onRetry={loadData} debugInfo={debugInfo} />
          )}
          ...
          {!loading && !error && data.length > 0 && (
            <>
              ...
              <ComparateurTable data={filteredData} selectedProduct={selectedProduct} />
            </>
          )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-900 dark:text-yellow-300 mb-2">
                  Les prix affichés proviennent de relevés citoyens vérifiés dans le cadre de
                ...
                <p className="text-sm text-yellow-800 dark:text-yellow-400">
                  ...
                  <Link
                    to="/methodologie"
                    className="font-semibold underline hover:text-yellow-600 dark:hover:text-yellow-300"
                  >
                    page méthodologie
                  </Link>
                  .
        ...
        <div className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 mt-12 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-500 text-xs mt-2">
              ...
              <Link to="/mentions-legales" className="hover:text-blue-600 dark:hover:text-blue-400">
                Mentions légales
              </Link>
            </p>
          </div>
