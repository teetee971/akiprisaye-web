...
export default function AnalyseNutri() {
  ...
  async function search(barcode: string) {
    ...
    try {
      ...
      setHistory((h) =>
        [{ code: barcode, name, ns }, ...h.filter((i) => i.code !== barcode)].slice(0, 5)
      );
    } catch (err: unknown) {
      ...
      >
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <form
            ...
            style={{ display: 'flex', gap: '0.6rem', marginBottom: '1.25rem' }}
          >
            <input
              value={query}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                background: loading ? 'rgba(14,165,233,0.35)' : 'rgba(14,165,233,0.8)',
                color: '#fff',
                fontSize: '0.88rem',
                fontWeight: 700,
                border: 'none',
          ...
          {error && (
            ...
            >
              ⚠️ {error} —{' '}
              <a
                href="https://fr.openfoodfacts.org/cgi/search.pl"
                target="_blank"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <a
                    href={`https://fr.openfoodfacts.org/produit/${product?.code}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      fontSize: '0.68rem',
              ...
              >
                ...
                >
                  ...
                  {ns ? (
                    <>
                      <div
                        style={{
                          ...
                          height: 50,
                          borderRadius: 10,
                          background: NS_COLORS[ns] ?? '#64748b',
                          display: 'flex',
                          alignItems: 'center',
                    ...
                    <div style={{ color: '#334155', fontSize: '0.78rem', paddingTop: '0.5rem' }}>
                      Non disponible
                    </div>
                  )}
                  <a
                ...
                >
                    ...
                    <>
                      <div
                        style={{
                          ...
                          height: 50,
                          borderRadius: '50%',
                          background: NOVA_LABELS[nova]?.color ?? '#64748b',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          fontSize: '1.4rem',
                  ...
                  <a
                    href="https://fr.openfoodfacts.org/nova"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'block',
                    ...
                    <>
                      <div
                        style={{
                          ...
                          height: 50,
                          borderRadius: 10,
                          background: ECO_COLORS[eco] ?? '#64748b',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          fontSize: '1.6rem',
              ...
              {p.nutriments && (
                ...
                >
                  ...
                  >
                    ...
                    {p.serving_size ? `(portion : ${p.serving_size})` : ''}
                  </p>
                  <div
                    style={{
                      display: 'grid',
                      ...
                      return (
                        ...
                        >
                          ...
                          <span style={{ fontSize: '0.73rem', fontWeight: 700, color: '#e2e8f0' }}>
                            {key.includes('kcal')
                              ? `${Math.round(val)} kcal`
                              : `${typeof val === 'number' ? val.toFixed(1) : val}g`}
                          </span>
                        </div>
                      );
                    })}
              ...
              <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                {history.map((h) => (
                  ...
                  >
                    ...
                    {h.name.length > 20 ? '…' : ''}{' '}
                    {h.ns !== '?' && (
                      <strong style={{ color: NS_COLORS[h.ns] }}>({h.ns.toUpperCase()})</strong>
                    )}
                  </button>
                ))}
              </div>
          ...
          >
            <p style={{ margin: 0, fontSize: '0.72rem', color: '#38bdf8', lineHeight: 1.6 }}>
              ...
              — base de données alimentaire libre, collaborative et mondiale (licence ODbL).
              Nutri-Score selon{' '}
              <a
