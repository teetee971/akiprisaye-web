    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', padding: '1.5rem 1rem 3rem' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', padding: '0.3rem 1rem', borderRadius: 20, background: 'rgba(14,165,233,0.1)', border: '1px solid rgba(14,165,233,0.3)', marginBottom: '0.75rem' }}>
            <span style={{ fontSize: '0.78rem', color: '#38bdf8', fontWeight: 700 }}>🥗 Analyse nutritionnelle</span>
          </div>
          <h1 style={{ margin: '0 0 0.4rem', fontSize: '1.7rem', fontWeight: 900, color: '#f1f5f9' }}>
            Analyseur nutrition produit
          </h1>
          <p style={{ margin: 0, fontSize: '0.88rem', color: '#64748b' }}>
            Nutri-Score, NOVA, Éco-Score et composition — via{' '}
            <a href="https://fr.openfoodfacts.org/" target="_blank" rel="noopener noreferrer" style={{ color: '#38bdf8' }}>Open Food Facts</a>
          </p>
        </div>
