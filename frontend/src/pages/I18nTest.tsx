...
export default function I18nTest() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-8">Test i18n - AKiPriSaYe</h1>
      ...
      <div className="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        ...
        <div className="space-y-2">
          <p>
            <strong>Code:</strong> {currentLanguage.code}
          </p>
          <p>
            <strong>Name:</strong> {currentLanguage.name}
          </p>
          <p>
            <strong>Native:</strong> {currentLanguage.native}
          </p>
          <p>
            <strong>Flag:</strong> {currentLanguage.flag}
          </p>
          <p>
            <strong>Territory:</strong> {currentLanguage.territory}
          </p>
          <p>
            <strong>Is Creole:</strong> {isCreole ? 'Yes' : 'No'}
          </p>
        </div>
      </div>
      ...
      <div className="mb-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="space-y-3">
          ...
          <p>
            <strong>App Name:</strong> {t('common:app.name')}
          </p>
          <p>
            <strong>Tagline:</strong> {t('common:app.tagline')}
          </p>
          <p>
            <strong>Search:</strong> {t('common:nav.search')}
          </p>
          <p>
            <strong>Add Action:</strong> {t('common:actions.add')}
          </p>
          <p>
            <strong>Loading:</strong> {t('common:status.loading')}
          </p>
          ...
          <p>
            <strong>Nearby Stores:</strong> {t('home:nearby.title')}
          </p>

          <h3 className="font-medium text-lg mt-4">Store Namespace</h3>
          <p>
            <strong>Store Details:</strong> {t('store:details.title')}
          </p>
          <p>
            <strong>Monday:</strong> {t('store:hours.monday')}
          </p>
          <p>
            <strong>Reviews:</strong> {t('store:reviews.title')}
          </p>
        </div>
      </div>
      ...
      <div className="mb-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="space-y-3">
          <p>
            <strong>Price:</strong> {formatPrice(testPrice)}
          </p>
          <p>
      ...
      <div className="mb-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="space-y-3">
          <p>
            <strong>Opens at:</strong> {t('common:time.opensAt', { time: '09:00' })}
          </p>
          <p>
            <strong>Closes at:</strong> {t('common:time.closesAt', { time: '18:00' })}
          </p>
          <p>
            <strong>Review count:</strong> {t('store:reviews.count', { count: 5 })}
          </p>
          <p>
            <strong>Product count:</strong> {t('store:products.count', { count: 42 })}
          </p>
        </div>
      </div>
