        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-5 space-y-5">
          ...
          <div className="animate-fade-in">
            ...
            >
              ...
              <p className="text-slate-200 text-sm drop-shadow max-w-2xl">
                Un canal clair, sans scraping ni API privées : contributions humaines vérifiées,
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            <h2 className="text-xl font-semibold text-white">
              Comment les données sont vérifiées ?
            </h2>
            <ul className="list-disc list-inside text-slate-200 space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Les données horaires reflètent les dernières observations disponibles, sans promesse
              de « live garanti ».
            </p>
          </section>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-slate-200">
              Pour déposer vos relevés : passez par le formulaire sécurisé ou contactez-nous pour un
              dépôt CSV encadré.
            </p>
