...
const SLIDES: Slide[] = [
  {
    id: 'cover',
    emoji: '🎙️',
    title: 'Vie chère en Outre-Mer',
    subtitle: 'Comprendre les écarts de prix',
    accentColor: '#6366f1',
  },
  {
    id: 'constat',
    emoji: '📊',
    title: 'Le constat chiffré',
    subtitle: "Des écarts allant jusqu'à +40 %",
    accentColor: '#3b82f6',
  },
  {
    id: 'fret',
    emoji: '🚢',
    title: 'Facteur 1 — Le fret maritime',
    subtitle: '+6 % à +18 % selon le territoire',
    accentColor: '#0ea5e9',
  },
  {
    id: 'octroi',
    emoji: '🏛️',
    title: "Facteur 2 — L'Octroi de mer",
    subtitle: 'Une taxe vieille de 350 ans',
    accentColor: '#a855f7',
  },
  {
    id: 'marche',
    emoji: '🏪',
    title: 'Facteur 3 — Concentration du marché',
    subtitle: 'Oligopole et faible concurrence',
    accentColor: '#f59e0b',
  },
  {
    id: 'pouvoir',
    emoji: '💸',
    title: "Facteur 4 — Pouvoir d'achat",
    subtitle: 'Le double impact sur les ménages',
    accentColor: '#ef4444',
  },
  {
    id: 'solutions',
    ...
    subtitle: 'Outils, droits et dispositifs officiels',
    accentColor: '#22c55e',
  },
];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '1rem', color: '#94a3b8' }}>
          de surcoût alimentaire dans les DOM / COM vs France métropolitaine
        </div>
      </div>
          ...
          >
            ...
            >
              <div
                style={{
                  height: '100%',
                  width: `${row.pct === 0 ? 2 : (row.pct / 20) * 100}%`,
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'INSEE — Niveaux de vie DOM',
        ...
        />
        <SourcePill
          source={{ label: 'CEROM', url: 'https://www.cerom-outremer.fr/', year: '2022' }}
        />
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      <p style={{ margin: 0, fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Les enquêtes officielles mesurent précisément les écarts. Ces chiffres sont issus des
        publications <strong style={{ color: '#e2e8f0' }}>INSEE</strong> et{' '}
                ...
                >
                  ...
                  <td
                    style={{
                      ...
                      fontWeight: 700,
                      color: isRef ? '#22c55e' : row.pct >= 15 ? '#ef4444' : '#fbbf24',
                    }}
                  >
                    {isRef ? 'réf.' : `+${row.pct} %`}
                  </td>
                  <td
                    style={{
                      padding: '0.45rem 0.6rem',
                      color: row.chomage > 15 ? '#f97316' : '#94a3b8',
                    }}
                  >
                    {row.chomage} %
                  </td>
                  <td style={{ padding: '0.45rem 0.6rem', color: '#94a3b8' }}>
                    {row.pib.toLocaleString('fr-FR')} €
                  </td>
                  <td
                    style={{
                      padding: '0.45rem 0.6rem',
                      color: isRef ? '#22c55e' : '#94a3b8',
                      fontWeight: isRef ? 700 : 400,
                    }}
                  >
                    {row.salaire.toLocaleString('fr-FR')} €/an
                  </td>
                </tr>
              );
            })}
      ...
      <div style={card()}>
        <p style={{ margin: '0 0 0.6rem', fontSize: '0.75rem', color: '#94a3b8', fontWeight: 600 }}>
          Surcoût alimentaire (%) par rapport à la métropole
        </p>
        <svg
          viewBox="0 0 420 90"
          style={{ width: '100%', height: 90 }}
          aria-label="Graphique surcoût alimentaire par territoire"
        >
          {[
            ...
            <g key={b.l}>
              <rect
                x={b.x}
                y={70 - (b.w === 0 ? 2 : b.w * 0.65)}
                width={42}
                height={b.w === 0 ? 2 : b.w * 0.65}
                fill={b.color}
                rx={3}
              />
              <text x={b.x + 21} y={84} textAnchor="middle" fill="#94a3b8" fontSize="9">
                {b.l}
              </text>
              <text
                x={b.x + 21}
                y={65 - (b.w === 0 ? 2 : b.w * 0.65)}
                textAnchor="middle"
                fill={b.color}
                fontSize="8"
                fontWeight="bold"
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'INSEE — Budget de Famille DOM',
            url: 'https://www.insee.fr/fr/statistiques/2586930',
            year: '2017/18',
          }}
        />
...
function FretSlide() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      <p style={{ margin: 0, fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Pratiquement{' '}
        <strong style={{ color: '#e2e8f0' }}>90 % des produits de grande consommation</strong>{' '}
        vendus dans les DOM sont importés par voie maritime depuis la métropole ou d'autres
        continents. Le coût du fret se répercute directement sur le prix en rayon.
      </p>

      {/* SVG Route map (stylized) */}
      <div style={card()}>
        <p style={{ margin: '0 0 0.5rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Distances maritimes depuis Le Havre (en km)
        </p>
        <svg
          viewBox="0 0 420 130"
          style={{ width: '100%', height: 130 }}
          aria-label="Carte des routes maritimes vers les DOM"
        >
          {/* Ocean background */}
          ...
          <ellipse
            ...
            strokeWidth={1.5}
          />
          <text x={90} y={49} textAnchor="middle" fill="#a5b4fc" fontSize="9" fontWeight="bold">
            🇫🇷 France
          </text>
          {/* Routes + destinations */}
          {[
            ...
            <g key={d.label}>
              ...
              <text x={d.cx} y={d.cy + 18} textAnchor="middle" fill="#64748b" fontSize="6.5">
                {d.km}
              </text>
              <text
                x={d.cx}
          ...
          {/* Ship icon */}
          <text x={155} y={48} fontSize={14} style={{ pointerEvents: 'none' }}>
            🚢
          </text>
          <text x={270} y={55} fontSize={12} style={{ pointerEvents: 'none' }}>
            🚢
          </text>
        </svg>
      </div>
          ...
          <tbody>
            {routes.map((r, i) => (
              ...
              >
                ...
                <td style={{ padding: '0.4rem 0.6rem', fontWeight: 700, color: r.color }}>
                  {r.surcoût}
                </td>
              </tr>
            ))}
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        ...
        <SourcePill
          source={{
            label: 'IEDOM — Tableau de bord transport',
            url: 'https://www.iedom.fr/iedom/publications/rapports-annuels.html',
            year: '2023',
          }}
        />
        <SourcePill
          source={{
            label: 'Douane FR — Stats fret DOM',
            url: 'https://www.douane.gouv.fr/la-douane/politique-douaniere/statistiques-du-commerce-exterieur',
            year: '2022',
          }}
        />
      </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem' }}>
        <div style={card()}>
          <p
            style={{ margin: '0 0 0.5rem', fontSize: '0.8rem', color: '#c084fc', fontWeight: 700 }}
          >
            📜 Qu'est-ce que l'octroi de mer ?
          </p>
          <p style={{ margin: 0, fontSize: '0.78rem', color: '#94a3b8', lineHeight: 1.6 }}>
            C'est une <strong style={{ color: '#e2e8f0' }}>taxe douanière locale</strong> perçue à
            l'entrée des marchandises dans les Départements et Régions d'Outre-Mer (DROM). Elle
            existe depuis <strong style={{ color: '#c084fc' }}>1670</strong> et finance en moyenne{' '}
            <strong style={{ color: '#e2e8f0' }}>35 à 40 %</strong> des budgets des collectivités
            locales.
          </p>
        </div>
        <div style={card()}>
          ...
          <p style={{ margin: 0, fontSize: '0.78rem', color: '#94a3b8', lineHeight: 1.6 }}>
            Le Règlement UE <strong style={{ color: '#e2e8f0' }}>2022/2</strong> proroge le
            dispositif jusqu'au <strong style={{ color: '#c084fc' }}>31 décembre 2030</strong>. Il
            permet aux DROM de maintenir des taux différenciés pour protéger la production locale
      ...
      {/* SVG flow diagram */}
      <div style={card()}>
        <p style={{ margin: '0 0 0.6rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Flux de l'octroi de mer — qui paie, qui perçoit ?
        </p>
        <svg
          viewBox="0 0 420 90"
          style={{ width: '100%', height: 90 }}
          aria-label="Diagramme du flux de l'octroi de mer"
        >
          {/* Step boxes */}
          {[
            {
            ...
            <g key={b.label}>
              <rect
                ...
                strokeWidth={1.2}
              />
              <text x={b.x + 38} y={34} textAnchor="middle" fontSize="11">
                {b.label.split(' ')[0]}
              </text>
              <text
                x={b.x + 38}
              ...
              <text x={b.x + 38} y={56} textAnchor="middle" fill="#64748b" fontSize="7">
                {b.sub}
              </text>
              {i < 3 && (
                <polygon points={`${b.x + 83},38 ${b.x + 90},34 ${b.x + 90},42`} fill="#475569" />
              )}
            </g>
          ))}
          {/* Collectivité arrow */}
          ...
          <text x={263} y={0} textAnchor="middle" fill="#a855f7" fontSize="7">
            Collectivité locale (35–40 % budget)
          </text>
        </svg>
      </div>
      ...
      {/* Tax rates */}
      <div style={card()}>
        <p style={{ margin: '0 0 0.7rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Taux d'octroi de mer par catégorie de produit (fourchettes moyennes)
        </p>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        ...
        <SourcePill
          source={{
            label: 'DGDDI — Douane française',
            url: 'https://www.douane.gouv.fr/la-douane/politique-douaniere/loctroi-de-mer',
            year: '2023',
          }}
        />
        <SourcePill
          source={{
            label: 'Vie-Publique — Octroi de mer',
            url: 'https://www.vie-publique.fr/eclairage/18680-loctroi-de-mer-une-taxe-specifique-aux-drom',
            year: '2023',
          }}
        />
      </div>
...
function MarcheSlide() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      <div style={card()}>
        <p style={{ margin: '0 0 0.6rem', fontSize: '0.8rem', color: '#fbbf24', fontWeight: 700 }}>
          ⚖️ Qu'est-ce qu'un oligopole de distribution ?
        </p>
        <p style={{ margin: 0, fontSize: '0.78rem', color: '#94a3b8', lineHeight: 1.65 }}>
          En métropole, des dizaines de chaînes se font concurrence. Dans les DOM, 2 à 4 groupes
          familiaux contrôlent{' '}
          <strong style={{ color: '#e2e8f0' }}>70 à 80 % de la grande distribution</strong>. Ce
          manque de concurrence leur permet de pratiquer des marges commerciales{' '}
          <strong style={{ color: '#fbbf24' }}>2 à 3 fois plus élevées</strong> qu'en métropole —
          sans pression du marché pour les réduire. L'Autorité de la concurrence a documenté ce
          phénomène dès 2009.
        </p>
      </div>
      ...
      <div style={card()}>
        <p style={{ margin: '0 0 0.5rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Habitants par grande surface — plus le chiffre est élevé, moins il y a de concurrence
        </p>
        <svg
          viewBox="0 0 420 100"
          style={{ width: '100%', height: 100 }}
          aria-label="Concentration du marché par territoire"
        >
          {comparison.map((c, i) => {
            ...
            return (
              <g key={c.label}>
                <text x={0} y={y + 11} fill="#94a3b8" fontSize="8.5" dominantBaseline="middle">
                  {c.label}
                </text>
                <rect
                  x={105}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem' }}>
        {[
          {
            label: 'Marge nette France métro.',
            value: '1–3 %',
            color: '#22c55e',
            desc: 'Les grandes enseignes jouent sur les volumes',
          },
          {
            label: 'Marge nette DOM',
            value: '6–12 %',
            color: '#ef4444',
            desc: 'Oligopole = moins de pression tarifaire',
          },
        ].map((m) => (
          <div key={m.label} style={card({ textAlign: 'center', borderColor: `${m.color}44` })}>
            ...
            <div
              style={{ fontSize: '0.78rem', color: '#e2e8f0', fontWeight: 600, margin: '0.2rem 0' }}
            >
              {m.label}
            </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        ...
        <SourcePill
          source={{
            label: 'Autorité de la concurrence — Avis 19-A-12',
            url: 'https://www.autoritedelaconcurrence.fr/fr/decision/relatif-a-la-situation-concurrentielle-dans-le-secteur-de-la-grande-distribution-en',
            year: '2019',
          }}
        />
        <SourcePill
          source={{
            label: 'INSEE — Commerce de détail DOM',
            url: 'https://www.insee.fr/fr/statistiques/zones/2586930',
            year: '2022',
          }}
        />
      </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      <div style={card({ borderColor: 'rgba(239,68,68,0.3)', background: 'rgba(239,68,68,0.06)' })}>
        <p style={{ margin: '0 0 0.4rem', fontSize: '0.8rem', color: '#fca5a5', fontWeight: 700 }}>
          ⚠️ Le double impact sur les ménages
        </p>
        <p style={{ margin: 0, fontSize: '0.8rem', color: '#fca5a5', lineHeight: 1.65 }}>
          ...
          <em>et</em> des <strong>revenus plus faibles</strong>. À Mayotte, le revenu médian est de{' '}
          <strong>5 600 €/an</strong> — soit <strong>4 fois moins</strong> qu'en métropole — pour
          des prix alimentaires <strong>14 % plus élevés</strong>.
        </p>
      </div>
      ...
      <div style={card()}>
        <p style={{ margin: '0 0 0.5rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Revenu médian disponible (€/an) — source INSEE RDL 2021
        </p>
        <svg
          viewBox="0 0 420 120"
          style={{ width: '100%', height: 120 }}
          aria-label="Comparaison revenus médians par territoire"
        >
          {incomes.map((d, i) => {
            ...
            return (
              <g key={d.t}>
                ...
                <text x={x + 24} y={104} textAnchor="middle" fill="#64748b" fontSize="7.5">
                  {d.flag} {d.t.split(' ')[0]}
                </text>
              </g>
            );
      ...
      <div style={card()}>
        <p style={{ margin: '0 0 0.7rem', fontSize: '0.75rem', color: '#64748b', fontWeight: 600 }}>
          Taux de pauvreté (seuil 60 % rev. médian) vs métropole
        </p>
        {incomes.map((d) => {
            ...
            >
              ...
              >
                <div
                  style={{
                    height: '100%',
                    width: `${Math.min(100, (d.pauvrete / 80) * 100)}%`,
                    background: d.color,
                    borderRadius: 4,
              ...
              {d.t !== 'France métro.' && (
                <span style={{ ...accent(d.color), fontSize: '0.62rem' }}>
                  ×{relPauvrete.toFixed(1)}
                </span>
              )}
            </div>
          );
        ...
        <p style={{ margin: '0.6rem 0 0', fontSize: '0.65rem', color: '#475569' }}>
          ×N = multiplicateur par rapport au taux métropolitain (15,6 %). Source : INSEE — Pauvreté
          dans les DOM 2021.
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        ...
        <SourcePill
          source={{
            label: 'INSEE — Taux de pauvreté DOM',
            url: 'https://www.insee.fr/fr/statistiques/6527766',
            year: '2021',
          }}
        />
        <SourcePill
          source={{
            label: 'IEDOM — Rapport annuel Mayotte',
            url: 'https://www.iedom.fr/iedom/publications/rapports-annuels.html',
            year: '2023',
          }}
        />
...
function SolutionsSlide() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
      <p style={{ margin: 0, fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Face à la vie chère, des mécanismes existent — mais leur efficacité dépend de la
        mobilisation collective. Voici les outils{' '}
        <strong style={{ color: '#e2e8f0' }}>officiels et citoyens</strong> à votre disposition.
      </p>
    ...
    >
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              {slide.subtitle && (
                <p
                  style={{ margin: 0, fontSize: '0.8rem', color: '#64748b', marginTop: '0.15rem' }}
                >
                  {slide.subtitle}
                </p>
              )}
        ...
        >
          ...
          <span style={{ fontSize: '0.75rem', color: '#475569' }}>Touches ← → pour naviguer</span>
