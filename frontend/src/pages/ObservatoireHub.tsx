...
export default function ObservatoireHub() {
  ...
  const renderChangeBadge = (change: 'up' | 'down' | 'stable') => {
    if (change === 'up') {
      return (
        <span className="rounded-full bg-emerald-500/20 px-2 py-0.5 text-xs text-emerald-200 inline-flex items-center gap-1">
    ...
    if (change === 'down') {
      return (
        <span className="rounded-full bg-rose-500/20 px-2 py-0.5 text-xs text-rose-200 inline-flex items-center gap-1">
          <ChevronDown className="w-3 h-3" aria-hidden="true" />
        </span>
      );
    }
    return (
      <span className="rounded-full bg-slate-700/60 px-2 py-0.5 text-xs text-slate-200 inline-flex items-center gap-1">
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Données citoyennes transparentes, relevés terrain vérifiés et comparaisons territoriales en temps réel dans les DOM-TOM."
        />
      ...
      <div className="min-h-screen bg-slate-950 p-3 sm:p-4 pt-10 sm:pt-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-5 sm:mb-8">
            ...
            >
              ...
              <p className="text-slate-200 drop-shadow text-sm sm:text-base mt-1 max-w-2xl">
                Données citoyennes transparentes · Relevés terrain vérifiés · Comparaisons
                territoriales en temps réel
              </p>
            </HeroImage>
          </div>
          ...
          <GlassCard className="mb-4 sm:mb-6 p-1.5 sm:p-2">
            <div className="grid grid-cols-4 gap-1 sm:gap-1.5">
              {(
                [
                  {
                    id: 'dashboard' as ObservatoireTab,
                    emoji: '📊',
                    label: 'Dashboard',
                    Icon: BarChart3,
                  },
                  {
                    id: 'diagnostic' as ObservatoireTab,
                    emoji: '🔍',
                    label: 'Diagnostic',
                    Icon: Search,
                  },
                  {
                    id: 'palmares' as ObservatoireTab,
                    emoji: '🏆',
                    label: 'Palmarès',
                    Icon: Award,
                  },
                  {
                    id: 'donnees' as ObservatoireTab,
                    emoji: '📂',
                    label: 'Données',
                    Icon: Database,
                  },
          ...
          <div>
            {activeTab === 'dashboard' && (
              <Suspense
                fallback={
                  <div
                    className="h-96 rounded-2xl border border-white/10 bg-slate-900/50"
                    aria-hidden="true"
                  />
                }
              >
              ...
              <GlassCard>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
                  ...
                  <div className="bg-slate-900/50 rounded-xl border border-slate-800 overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-300 text-sm mb-2">
                        Épicerie <span className="text-orange-400 font-semibold">+39%</span>,
                        Boissons <span className="text-red-400 font-semibold">+101%</span>…
                        découvrez le détail par rayon.
                      </p>
                      <p className="text-gray-500 text-xs mb-3">
                        Données mars 2026 · 1 200 produits analysés
                      </p>
                      <Link
                        to="/observatoire"
                  ...
                  <div className="bg-slate-900/50 rounded-xl border border-slate-800 overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-300 text-sm mb-2">
                        Leader Price le moins cher en Guadeloupe, E.Leclerc{' '}
                        <span className="text-red-400 font-semibold">+97%</span> vs métropole.
                      </p>
                      <p className="text-gray-500 text-xs mb-3">
                        Classement sur 150 magasins · 9 territoires
                      </p>
                      <Link
                  ...
                  <div className="bg-slate-900/50 rounded-xl border border-slate-800 overflow-hidden">
                    <div className="bg-orange-900/40 border-b border-orange-700/30 px-4 py-2.5 flex items-center gap-2">
                      <TrendingUp
                        ...
                        aria-hidden="true"
                      />
                      <h3 className="font-semibold text-sm text-orange-200">
                        Évolution temporelle
                      </h3>
                    </div>
                    <div className="p-4">
                      <p className="text-gray-300 text-sm mb-2">
                        Suivi mensuel jan→mar 2026 :{' '}
                        <span className="text-orange-400 font-semibold">+7,4%</span> de hausse
                        alimentaire en Guadeloupe.
                      </p>
                  ...
                  <div className="bg-slate-900/50 rounded-xl border border-slate-800 overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-300 text-sm mb-2">
                        Saint-Barthélemy <span className="text-red-400 font-semibold">+99%</span>,
                        Guyane <span className="text-orange-400 font-semibold">+59%</span>,
                        Guadeloupe <span className="text-yellow-400 font-semibold">+39%</span> vs
                        Hexagone.
                      </p>
                      <p className="text-gray-500 text-xs mb-3">
                        9 territoires · comparaison avec la métropole
                      </p>
                      <Link
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setSelectedTerritory(event.target.value as TerritoryCode)
                      }
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500">
                              Score : {entry.score}/100 • {entry.note}
                            </div>
                          </div>
                ...
                <div className="flex flex-wrap gap-4 mb-5 p-4 bg-slate-900/60 rounded-xl border border-slate-700/40">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-300">
                      <span className="font-bold text-white">15</span> snapshots disponibles
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Globe className="w-4 h-4 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-sm text-gray-300">
                      <span className="font-bold text-white">9 territoires</span> × 3 mois = mars
                      2026
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
                  <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-800">
                    ...
                    <p className="text-gray-400 text-sm mb-3">
                      Téléchargez le palmarès du territoire sélectionné au format CSV
                    </p>
                    <button
                      type="button"
                ...
                <div className="bg-emerald-900/20 border border-emerald-700/30 rounded-xl p-4 mb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">
                      Partagez vos relevés de prix depuis votre territoire pour enrichir
          ...
          <div className="mt-6 sm:mt-8">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-3">Indicateurs clés</h2>
