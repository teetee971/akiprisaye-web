...
const MOCK_AIRLINES: FlightResult[] = [
  ...
  { airline: 'Corsair International', price: 0, duration: '9h15', stops: 0, logo: '🛫', refPrice: 120 },
...
export default function ComparateurTransport() {
  ...
  function handleAddAlert() {
    ...
    if (!price || price <= 0) { toast.error('Prix cible invalide'); return; }
      ...
      <div className='min-h-screen bg-gray-50'>
        <div className='max-w-4xl mx-auto px-4 py-6 pb-12 space-y-6'>
          ...
          <div className='bg-amber-50 border border-amber-200 rounded-xl p-3 text-xs text-amber-800'>
            ...
            référence reconstituées à titre indicatif (source DGAC/OACI 2024). Les prix réels peuvent varier.
          </div>
          ...
          <div className='bg-white border border-gray-200 rounded-2xl p-5'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4'>
              <div>
                <label htmlFor='ct-from' className='block text-xs font-medium text-gray-600 mb-1'>Départ (DOM)</label>
                <select
                  id='ct-from'
                  value={from}
              ...
              <div>
                <label htmlFor='ct-to' className='block text-xs font-medium text-gray-600 mb-1'>Destination</label>
                <select
                  id='ct-to'
                  value={to}
              ...
              <div>
                <label htmlFor='ct-date' className='block text-xs font-medium text-gray-600 mb-1'>Date de départ</label>
                <input
                  id='ct-date'
                  type='date'
                  value={date}
              ...
              <div>
                <label htmlFor='ct-passengers' className='block text-xs font-medium text-gray-600 mb-1'>
              ...
              <table className='w-full text-sm'>
                <thead className='bg-gray-50 border-b border-gray-200'>
                  <tr>
                    ...
                    <th className='px-4 py-2 text-right text-xs font-semibold text-gray-600'>Basse saison</th>
                    <th className='px-4 py-2 text-right text-xs font-semibold text-gray-600'>Haute saison</th>
                  </tr>
                </thead>
          ...
          <div className='bg-white border border-gray-200 rounded-2xl p-5'>
            ...
            {alerts.length === 0 ? (
              ...
              <div className='space-y-2'>
                {alerts.map((a) => (
                  <div key={a.id} className='flex items-center justify-between bg-blue-50 border border-blue-100 rounded-xl px-4 py-2.5'>
                    <div>
