      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex gap-8">
        ...
        <main className="flex-1 min-w-0 space-y-8 pb-12">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Les cinq Départements et Régions d'Outre-mer (Guadeloupe, Martinique, Guyane,
              La Réunion, Mayotte) et les Collectivités d'Outre-mer (Saint-Martin, Saint-Barthélemy,
            ...
            <ul className="space-y-2 text-gray-700 mb-5">
              ...
              <Li>
                ...
                outil numérique indépendant pour comparer les prix entre enseignes ou
                entre territoires.
              </Li>
            </ul>

            <Callout type="source">
              Des études régulières de la DGCCRF, de l'INSEE et des observatoires régionaux des
              prix documentent des écarts de prix significatifs et persistants entre les DOM et la
            ...
            <ul className="space-y-2 text-gray-700">
              <Li>Données partielles ou non actualisées dans les outils de comparaison généralistes</Li>
              <Li>Absence de traçabilité des prix observés (qui a mesuré quoi, quand, où ?)</Li>
              <Li>Pas d'outil citoyen intégrant scan produit, historique et alertes dans les DOM</Li>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
              {[
                ...
                { title: 'Devis IA institutionnels', desc: 'Module B2G : demande de devis structuré, estimation expliquée, validation humaine obligatoire.' },
              ].map((m) => (
            ...
            <Callout type="info">
              <strong>Principe fondamental :</strong> tout est sourcé, traçable et auditable.
              Aucune donnée n'est présentée sans horodatage, origine et méthode de collecte.
              L'IA reste explicable — aucune "boîte noire" dans les estimations.
            </Callout>
          </Section>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <Step n={1} label="Concentration ultramarine" desc="Ancrage fort dans les DOM-COM : niche documentée, besoin réel, concurrence faible." />
              <Step n={2} label="Extension multi-territoires" desc="Montée en charge progressive vers l'ensemble des territoires ultramarins et COM éloignées." />
              <Step n={3} label="Ouverture nationale comparative" desc="Extension vers la France métropolitaine comme référentiel comparatif, une fois la base ultramarine consolidée." />
            </div>

            <Callout type="warn" className="mt-5">
              <strong>Hypothèse de travail :</strong> L'extension nationale est conditionnée à la
              consolidation du modèle sur les territoires d'Outre-mer. Aucun calendrier
              d'extension métropolitaine n'est présenté comme acquis.
            </Callout>
          </Section>
          ...
          >
            <p className="text-gray-700 mb-4">
              ...
              aux fonctions citoyennes essentielles reste libre. La monétisation repose sur des
              services à valeur ajoutée différenciée.
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="text-left px-4 py-2 border border-gray-200 font-semibold text-gray-700">Offre</th>
                    <th className="text-left px-4 py-2 border border-gray-200 font-semibold text-gray-700">Cible</th>
                    <th className="text-left px-4 py-2 border border-gray-200 font-semibold text-gray-700">Tarif</th>
                    <th className="text-left px-4 py-2 border border-gray-200 font-semibold text-gray-700">Caractéristique</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { offre: 'Gratuit', cible: 'Tous citoyens', tarif: '0 €/mois', cara: 'Fonctions de base, contribution citoyenne' },
                    { offre: 'Citoyen Premium', cible: 'Citoyens actifs', tarif: '3,99 €/mois · 39 €/an', cara: 'Scan illimité, OCR, alertes, historique 12 mois' },
                    { offre: 'Pro', cible: 'Associations, analystes, pros', tarif: '19 €/mois · 190 €/an', cara: 'Exports, agrégations, historique long, multi-territoires' },
                    { offre: 'Business', cible: 'Équipes, exploitation intensive', tarif: '99 €/mois · 990 €/an', cara: 'Listes partagées, tableaux de bord équipe, accès étendu' },
                    { offre: 'Institution', cible: 'Collectivités, État, chercheurs', tarif: 'Sur devis annuel', cara: 'Licence dédiée, open-data structuré, observatoire officiel' },
                    { offre: 'Prestations IA', cible: 'Institutions, cabinets', tarif: 'Devis au projet', cara: 'Rapports, audits, études territoriales personnalisées' },
                  ].map((r) => (
                    <tr key={r.offre} className="border-b border-gray-200">
                      ...
                      <td className="px-4 py-2 border border-gray-200 text-indigo-700 font-medium">{r.tarif}</td>
            ...
            <ul className="space-y-2 text-gray-700">
              <Li><strong>Revenus récurrents :</strong> abonnements mensuels et annuels prévisibles.</Li>
              <Li><strong>Faible coût marginal :</strong> infrastructure cloud à coût fixe, pas de coût variable lié au nombre d'utilisateurs.</Li>
              <Li><strong>Fort potentiel B2G :</strong> les institutions publiques constituent un marché stable et à haute valeur unitaire.</Li>
              <Li><strong>Pas de revenus publicitaires :</strong> modèle d'indépendance éditoriale préservée.</Li>
            </ul>
          </Section>
          ...
          >
            <Callout type="warn" className="mb-5">
              ...
              d'usage consolidées. Aucun chiffre d'utilisateurs actifs ne sera mentionné sans
              source vérifiable.
            </Callout>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
              {[
                { label: 'Territoires couverts', value: '12 territoires', note: 'DOM + COM français intégrés dans le comparateur' },
                { label: 'Modules opérationnels', value: '8 modules', note: 'Comparateur, Scanner, OCR, Carte, Observatoire, Alertes, Messagerie, Groupes citoyens' },
                { label: 'Routes applicatives', value: '130+ pages', note: 'Application complète, fonctionnelle et déployée' },
                { label: 'Infrastructure', value: 'Cloudflare Pages', note: 'CI/CD industriel, déploiement continu opérationnel' },
                { label: 'Utilisateurs actifs', value: 'Phase pilote', note: 'Métriques en cours de consolidation — non communiquées à ce stade' },
                { label: 'Demandes institutionnelles', value: 'En cours', note: 'Module devis IA opérationnel — pipeline en construction' },
              ].map((m) => (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {[
                { layer: 'Frontend', tech: 'React 18 + TypeScript + Vite', detail: 'SPA modulaire, code-splitting, accessibilité WCAG' },
                { layer: 'Style', tech: 'Tailwind CSS 4 + Framer Motion', detail: 'Design system cohérent, animations accessibles' },
                { layer: 'Base de données', tech: 'Firebase Firestore', detail: 'NoSQL temps réel, subscriptions, règles de sécurité' },
                { layer: 'Authentification', tech: 'Firebase Auth', detail: 'Multi-provider, gestion des rôles (citoyen / pro / admin)' },
                { layer: 'Déploiement', tech: 'Cloudflare Pages', detail: 'CDN mondial, déploiement atomique, rollback instantané' },
                { layer: 'CI/CD', tech: 'GitHub Actions', detail: 'Tests automatiques, lint, build, déploiement continu' },
                { layer: 'Tests', tech: 'Vitest + Testing Library', detail: '76+ fichiers de test, couverture fonctionnelle et service' },
                { layer: 'IA', tech: 'Modèles explicables maison', detail: 'Pas de LLM opaque — règles métier documentées et auditables' },
              ].map((t) => (
                <div key={t.layer} className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                  <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">{t.layer}</p>
            ...
            <ul className="space-y-2 text-gray-700">
              <Li><strong>IA explicable :</strong> les estimations présentent leur raisonnement ligne par ligne. Aucune prédiction sans justification affichée.</Li>
              <Li><strong>Données vérifiables :</strong> chaque observation de prix est horodatée, localisée et rattachée à une source.</Li>
              <Li><strong>Validation humaine obligatoire :</strong> aucun engagement contractuel ou devis n'est émis automatiquement par un système IA.</Li>
              <Li><strong>Open source :</strong> le code source est public sur GitHub, ce qui permet un audit indépendant.</Li>
            </ul>
          ...
          >
            <p className="text-gray-700 mb-5">
              ...
              phase avant passage à la suivante. Aucun calendrier n'est présenté comme une certitude.
            </p>
              ...
              {[
                ...
                <div key={p.phase} className={`border border-${p.color}-200 rounded-xl p-5`}>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full bg-${p.color}-100 text-${p.color}-700 font-medium`}>
                      {p.statut}
                    </span>
                  </div>
          ...
          >
              ...
              {[
                {
                  ...
                  profil: 'Initiateur et développeur principal de la plateforme. Connaissance approfondie des réalités économiques des DOM-COM et expertise technique sur la stack déployée.',
                },
                {
                ...
                },
                {
                  ...
                  profil: 'En cours de structuration — associations citoyennes, acteurs économiques locaux et relais territoriaux dans les DOM.',
                },
              ].map((m) => (
            ...
            <h3 className="text-base font-semibold text-gray-900 mb-3">Gouvernance éthique & data</h3>
            <ul className="space-y-2 text-gray-700">
              <Li>Charte de données publiquement accessible dans le dépôt GitHub</Li>
              <Li>Toute modification des règles de modération ou de collecte est documentée et versionnée</Li>
              <Li>Aucune donnée personnelle n'est revendue ou partagée à des tiers commerciaux</Li>
              <Li>Transparence sur les sources de financement futures (mention obligatoire dans les conditions d'utilisation)</Li>
            </ul>
          </Section>
          ...
          >
            ...
            <div className="space-y-3 mb-6">
              {[
                ...
                <div key={p.poste} className="flex items-start gap-4 border border-gray-200 rounded-xl p-4">
              ...
              {[
                {
                  ...
                  description: 'Les contributions citoyennes peuvent être incomplètes ou inexactes.',
                  mesure: 'Système de validation croisée, modération humaine, horodatage obligatoire, indicateur de confiance affiché.',
                  niveau: 'Maîtrisé',
                },
                {
                ...
                },
                {
                  ...
                  description: 'Évolution du cadre RGPD, des obligations des plateformes numériques (DSA, NIS2).',
                  mesure: 'Architecture RGPD-native, veille juridique, conformité intégrée dès la conception.',
                  niveau: 'Maîtrisé',
                },
                {
                ...
                <div key={r.risque} className="border border-gray-200 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full font-medium
                      ${r.niveau === 'Maîtrisé' ? 'bg-green-100 text-green-700'
                        : r.niveau === 'Suivi' ? 'bg-yellow-100 text-yellow-700'
          ...
          >
            <Callout type="info" className="mb-5">
              ...
              engagement contractuel. Chaque horizon est conditionnel à l'atteinte des
              jalons précédents.
            </Callout>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={v.horizon} className="border border-indigo-200 rounded-xl p-5 bg-indigo-50/30">
            ...
            <div className="mt-8 bg-slate-900 text-white rounded-2xl p-6 text-center">
              ...
              <p className="text-sm text-slate-300 leading-relaxed max-w-xl mx-auto">
                Transformer la transparence des prix ultramarins en bien commun numérique,
                au service des citoyens, des institutions et d'un développement territorial
                plus équitable.
              </p>
            </div>
...
function Callout({
  ...
  return (
    <div className={`border rounded-xl px-4 py-3 text-sm leading-relaxed ${styles[type]} ${className}`}>
      {children}
    </div>
  );
}
