...
const SLIDES: Slide[] = [
  {
    id: 'cover',
    emoji: '🏛️',
    title: "L'Octroi de Mer — Anatomie d'une taxe unique",
    subtitle: 'Conférence institutionnelle · Experts & élus',
    accentColor: '#7c3aed',
  },
  {
    id: 'histoire',
    emoji: '📜',
    title: "350 ans d'histoire — De Colbert à Bruxelles",
    subtitle: 'Genèse, crises juridiques et prorogations successives',
    accentColor: '#2563eb',
  },
  {
    id: 'droit',
    emoji: '⚖️',
    title: 'Architecture juridique : UE, TFUE, Loi 2004',
    subtitle: "Régimes RUP, différentiels et cadre d'autorisation",
    accentColor: '#0891b2',
  },
  {
    id: 'mecanisme',
    ...
    subtitle: 'Assiette, taux, collecte, reversement : le circuit complet',
    accentColor: '#059669',
  },
  {
    id: 'taux',
    emoji: '📊',
    title: 'Analyse des taux par territoire et secteur',
    subtitle: 'Différentiels, exonérations, exemples sectoriels',
    accentColor: '#d97706',
  },
  {
    id: 'impact',
    emoji: '💰',
    title: "Impact macroéconomique & pouvoir d'achat",
    subtitle: 'Vie chère, multiplicateurs de marges, données INSEE',
    accentColor: '#dc2626',
  },
  {
    id: 'budget',
    emoji: '📈',
    title: '1,2 Md€/an : financement des collectivités',
    subtitle: 'Répartition Région ↔ Communes, risques budgétaires',
    accentColor: '#7c3aed',
  },
  {
    id: 'reforme',
    emoji: '🔮',
    title: 'Horizon 2027 : scénarios de réforme',
    subtitle: 'Négociations UE, rapports Lurel, enjeux constitutionnels',
    accentColor: '#c026d3',
  },
  {
    id: 'conclusion',
    emoji: '💡',
    title: 'Synthèse & recommandations institutionnelles',
    subtitle: 'Ce que les données imposent comme conclusions',
    accentColor: '#16a34a',
  },
];
...
function WikiImg({
  ...
  return (
    ...
    >
      ...
      >
        {caption}{' '}
        <a href={creditUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#818cf8' }}>
          {credit}
        </a>
      </figcaption>
    </figure>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 1.7 }}>
        ...
        français. C'est aussi l'une des plus{' '}
        <strong style={{ color: '#fff' }}>méconnues du grand public</strong>, et pourtant l'une des
        plus <strong style={{ color: '#c4b5fd' }}>décisives pour le pouvoir d'achat</strong>
        des 2,2 millions d'habitants des cinq DROM. Cette conférence déconstruit son mécanisme avec
        la rigueur que les données imposent.
      </p>
...
function HistoireSlide() {
  const events = [
    {
      year: '1670',
      label: 'Ordonnance de Colbert',
      note: '"Droit de poids et entrée" aux Antilles',
      c: '#7c3aed',
    },
    {
      year: '1791',
      label: 'Révolution française',
      note: 'Nationalisation & harmonisation coloniale',
      c: '#2563eb',
    },
    {
      year: '1946',
      label: 'Loi de départ.',
      note: 'DOM intégrés à la Rép. — OM maintenu',
      c: '#0891b2',
    },
    {
      year: '1992',
      label: 'Arrêt CJCE Legros',
      note: 'Incompatibilité droit communautaire — réforme exigée',
      c: '#dc2626',
    },
    {
      year: '2004',
      label: 'Loi n° 2004-639',
      note: 'Architecture OM-R + OM-C, différentiels autorisés',
      c: '#059669',
    },
    {
      year: '2021',
      label: 'Déc. UE 2021/1657',
      note: "Prorogation jusqu'au 31 déc. 2027",
      c: '#d97706',
    },
    {
      year: '2027',
      label: 'Horizon',
      note: 'Renouvellement en négociation (Commission 2024)',
      c: '#c026d3',
    },
  ];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '0.73rem', color: '#94a3b8', lineHeight: 1.55 }}>
          ...
          constituait une taxe d'effet équivalant à un droit de douane —{' '}
          <strong style={{ color: '#fca5a5' }}>incompatible avec le marché commun</strong>. La
          France a obtenu une dérogation transitoire sous conditions strictes : justification des
          différentiels, liste positive de secteurs, durée limitée. Ces conditions structurent
          encore le régime actuel.
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'CJCE — Arrêt Legros C-163/90',
            url: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:61990CJ0163',
            year: '1992',
          }}
        />
        <SourcePill
        ...
        <SourcePill
          source={{
            label: 'Décision UE 2021/1657 — EUR-Lex',
...
function DroitSlide() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        L'octroi de mer repose sur un{' '}
        <strong style={{ color: '#fff' }}>empilement de normes</strong> allant du Traité européen
        jusqu'aux délibérations régionales. Chaque niveau conditionne le suivant. C'est cette
        architecture pyramidale qui le rend difficile à modifier unilatéralement.
      </p>
      ...
      {[
        ...
        {
          level: 2,
          label: 'Décision (UE) 2021/1657 du Conseil',
        ...
        {
          level: 4,
          label: 'Loi française n° 2004-639',
        ...
        {
          level: 5,
          label: 'Délibérations Conseils Régionaux',
        ...
        <div key={l.level} style={{ margin: '0 auto', width: l.width, transition: 'width 0.3s' }}>
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: '0.8rem', fontWeight: 700, color: l.color }}>
                {l.label}
              </p>
            </div>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '0.72rem', color: '#94a3b8', lineHeight: 1.55 }}>
          Le Conseil de l'UE peut autoriser des mesures spécifiques pour les RUP{' '}
          <em>
            "en tenant compte de la situation structurelle sociale et économique particulière des
            régions ultrapériphériques, qui est aggravée par leur éloignement, l'insularité, leur
            faible superficie, le relief et le climat difficiles, leur dépendance économique
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'TFUE Art. 349 — EUR-Lex',
            url: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:12012E349',
            year: 'TFUE 2012',
          }}
        />
        <SourcePill
          source={{
            label: 'Règlement UE 2022/2 — EUR-Lex',
...
function MecanismeSlide() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Sur le plan opérationnel, l'octroi de mer fonctionne comme un droit de douane interne à la
        France — mais avec des <strong style={{ color: '#fff' }}>particularités uniques</strong> :
      ...
      >
        ...
        <p style={{ margin: '0 0 0.3rem', fontSize: '0.82rem', color: '#e2e8f0', lineHeight: 1.6 }}>
          <span style={{ color: '#6ee7b7' }}>Base imposable</span> = Valeur CIF (coût + fret +
          assurance) en douane
        </p>
        <p style={{ margin: '0 0 0.3rem', fontSize: '0.82rem', color: '#e2e8f0' }}>
          <span style={{ color: '#fbbf24' }}>OM-R dû</span> = Base × Taux OM-R
          <sub style={{ fontSize: '0.6rem' }}>secteur</sub>
        </p>
        <p style={{ margin: '0 0 0.3rem', fontSize: '0.82rem', color: '#e2e8f0' }}>
      ...
      <div style={card()}>
        ...
        {[
          {
            step: 'A',
            label: 'Importateur / Producteur local',
            sub: "Déclare et paie l'OM mensuel à la DGDDI",
            c: '#0891b2',
          },
          {
            step: 'B',
            label: 'DGDDI — Douanes',
            sub: 'Liquidation, contrôle, encaissement. Statistiques publiées annuellement',
            c: '#059669',
          },
          {
            step: 'C',
            label: 'Trésor Public',
            sub: "Compte d'attente avant reversement territorial",
            c: '#d97706',
          },
          {
            step: 'D',
            label: 'Conseil Régional / Collectivité',
            sub: 'Reçoit OM-R (budget Région) + OM-C total à redistribuer',
            c: '#7c3aed',
          },
          {
            step: 'E',
            label: 'Communes du DROM',
            sub: 'OM-C réparti selon clé : population + superficie + DGF (dotation de base)',
            c: '#c026d3',
          },
        ].map((s, i) => (
          <div key={s.step}>
            <div style={{ display: 'flex', gap: '0.7rem', alignItems: 'flex-start' }}>
              ...
              <div>
                <p style={{ margin: 0, fontSize: '0.78rem', color: s.c, fontWeight: 700 }}>
                  {s.label}
                </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.65rem' }}>
        ...
        >
          <p
            style={{ margin: '0 0 0.3rem', fontSize: '0.78rem', color: '#a78bfa', fontWeight: 700 }}
          >
            OM-R — Budget Régional
          </p>
          <p style={{ margin: 0, fontSize: '0.7rem', color: '#94a3b8', lineHeight: 1.5 }}>
            Taux variable (0 % → 60 %) selon secteur et délibération · Recette propre de la Région ·
            Finance investissements et politiques régionales
          </p>
        </div>
        <div
          style={{
        ...
        >
          <p
            style={{ margin: '0 0 0.3rem', fontSize: '0.78rem', color: '#60a5fa', fontWeight: 700 }}
          >
            OM-C — Budget Communes
          </p>
          <p style={{ margin: 0, fontSize: '0.7rem', color: '#94a3b8', lineHeight: 1.5 }}>
            Taux fixe 2,5 % (toujours) · Péréquation intercommunale · Finance services de proximité
            (eau, écoles, voirie communale)
          </p>
        </div>
      </div>
...
function TauxSlide() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Les taux varient de <strong style={{ color: '#4ade80' }}>0 %</strong> (exonérations produits
        de base) à <strong style={{ color: '#f87171' }}>60 %</strong> (rhum importé en Martinique —
        protection de la production locale de rhum AOC). Cette amplitude reflète les{' '}
        <strong style={{ color: '#fff' }}>choix politiques</strong> des Conseils Régionaux.
      </p>
        ...
        {sectors.map((row) => (
          <div key={row.s} style={{ marginBottom: '0.7rem' }}>
            ...
            >
              ...
              <span style={{ fontSize: '0.7rem', fontWeight: 700, color: row.c }}>
                Δ {row.diff} pts
              </span>
            </div>
            <div
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '0.7rem', color: '#94a3b8', lineHeight: 1.55 }}>
          ...
          (décision régionale) · Matériels éducatifs · Engrais agricoles · Matériels pour
          associations humanitaires · Importations des collectivités publiques
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'Délibération CR Guadeloupe 2022',
        ...
        <SourcePill
          source={{
            label: 'Règlement UE 2022/2 — Annexes',
            url: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32022R0002',
            year: '2022',
          }}
        />
...
function ImpactSlide() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Mesurer l'impact réel de l'OM est complexe car il agit à travers plusieurs canaux. Les
        données officielles permettent néanmoins de le{' '}
        <strong style={{ color: '#fff' }}>quantifier rigoureusement</strong>, à condition de
        distinguer l'impact direct de l'effet multiplicateur.
      </p>
      ...
      <div style={card()}>
        ...
        {[
          ...
          {
            step: 'B',
            label: '+ Octroi de mer (OM-R 20 % + OM-C 2,5 %)',
            value: '+22,50 €',
            c: '#dc2626',
          },
          ...
          {
            step: '',
            label: 'Surcoût total vs prix métro (~140 €)',
            value: '+36 %',
            c: '#f87171',
            bold: true,
          },
          ...
          <div
            ...
            style={{
              ...
              gap: '0.5rem',
              padding: '0.3rem 0',
              borderBottom: row.step === 'G' ? '2px solid rgba(148,163,184,0.2)' : 'none',
              marginBottom: row.step === 'G' ? '0.3rem' : 0,
            }}
          >
            {row.step && (
              <span style={{ fontSize: '0.65rem', fontWeight: 800, color: row.c, minWidth: 16 }}>
                {row.step}
              </span>
            )}
            <span
              style={{
                flex: 1,
                fontSize: row.bold ? '0.8rem' : '0.73rem',
            ...
            <span
              style={{ fontSize: row.bold ? '0.82rem' : '0.75rem', fontWeight: 700, color: row.c }}
            >
              {row.value}
            </span>
          </div>
        ...
        <p style={{ margin: '0.4rem 0 0', fontSize: '0.62rem', color: '#334155' }}>
          * Illustration avec taux OM-R=20 %, marges Autorité de la concurrence Avis 19-A-12, TVA
          DOM 8,5 %. L'OM direct (+22,50 €) déclenche ~14 € de marges supplémentaires → effet
          multiplicateur ×2,4.
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'INSEE — Niveaux de vie DOM 2022',
        ...
        <SourcePill
          source={{
            label: 'Autorité concurrence — Avis 19-A-12',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        ...
        ressources fiscales des Conseils Régionaux selon les DROM. C'est la première ressource
        propre des régions d'outre-mer — devant toutes les dotations d'État. Sa suppression sans
          ...
          <tbody>
            {territories.map((row) => (
              <tr key={row.t} style={{ borderBottom: '1px solid rgba(148,163,184,0.06)' }}>
                ...
                <td style={{ padding: '0.35rem 0.6rem', color: '#c4b5fd', fontWeight: 700 }}>
                  {row.om} M€
                </td>
                <td style={{ padding: '0.35rem 0.6rem', color: '#94a3b8' }}>{row.budget} M€</td>
                <td style={{ padding: '0.35rem 0.6rem', color: '#fcd34d', fontWeight: 700 }}>
                  {row.pct} %
                </td>
      ...
      <p style={{ margin: 0, fontSize: '0.62rem', color: '#334155' }}>
        Sources : DGDDI 2023 ; Cour des Comptes — Rapport finances collectivités DOM 2023 ; IEDOM
        Rapports annuels 2023. Budget régional = budget de fonctionnement + investissement Région
        (hors communes). Estimations 2022-2023.
      </p>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '0.72rem', color: '#94a3b8', lineHeight: 1.55 }}>
          La Cour des Comptes (2023) note que certaines collectivités DOM n'ont{' '}
          <strong style={{ color: '#fca5a5' }}>pas diversifié leurs recettes fiscales</strong> en
          anticipation d'une réforme de l'OM. Une suppression brutale sans mesure compensatoire
          provoquerait des déficits de l'ordre de 20-30 % du budget de fonctionnement — rendant
          inévitable la mise sous tutelle financière. Le rapport Lurel-Hoibian (2019) estimait le
          besoin de compensation à <strong style={{ color: '#fca5a5' }}>1,2 Md€/an</strong> de DGF
          supplémentaires.
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'Cour des Comptes — Rapport DOM 2023',
        ...
        <SourcePill
          source={{
            label: 'Rapport Lurel-Hoibian 2019',
...
function ReformeSlide() {
  const scenarios = [
    {
      id: 'A',
      title: "Prorogation à l'identique",
      risk: 'Faible',
      impact: 'Nul',
      prob: 35,
      color: '#64748b',
    ...
    {
      id: 'B',
      title: 'Réforme des différentiels (Lurel)',
      risk: 'Modéré',
      impact: 'Modéré',
      prob: 30,
      color: '#2563eb',
    ...
    {
      id: 'C',
      title: 'Suppression sur produits de base',
      risk: 'Élevé',
      impact: 'Fort',
      prob: 20,
      color: '#059669',
    ...
    {
      id: 'D',
      title: 'Réforme structurelle globale',
      risk: 'Très élevé',
      impact: 'Très fort',
      prob: 15,
      color: '#c026d3',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      {scenarios.map((s) => (
        ...
        >
          ...
          >
            <div>
              <p style={{ margin: '0 0 0.2rem', color: '#4ade80', fontWeight: 600 }}>
                ✅ Avantages
              </p>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
        <SourcePill
          source={{
            label: 'Commission UE — Consultation 2024',
...
function ConclusionSlide() {
  const myths = [
    {
      ...
      truth:
        'NUANCÉ : Il représente ~30 % du surcoût. Les marges de distribution amplifiées et le fret maritime sont des facteurs de poids comparables (données INSEE 2022).',
    },
    {
      myth: "« Supprimer l'OM ferait immédiatement baisser les prix »",
      truth:
        "INCOMPLET : Sans réforme des marges de distribution, une suppression de l'OM bénéficierait d'abord aux importateurs et distributeurs. L'Autorité de la concurrence a documenté ces risques (Avis 19-A-12).",
    },
    {
      myth: "« L'OM est une taxe illégale imposée par la France »",
      truth:
        "FAUX : Il est explicitement autorisé par l'UE (Décision 2021/1657) sur la base de l'Art. 349 TFUE. Les Conseils Régionaux DOM en fixent eux-mêmes les taux.",
    },
    {
      myth: "« Les collectivités peuvent fonctionner sans l'OM »",
      truth:
        "FAUX : Il représente 22-32 % des budgets régionaux. Son remplacement nécessiterait soit une hausse d'autres taxes locales, soit 1,2 Md€/an de dotations supplémentaires de l'État (Rapport Lurel-Hoibian).",
    },
  ];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ margin: 0, fontSize: '0.83rem', color: '#cbd5e1', lineHeight: 1.65 }}>
        Cette conférence vous a fourni les outils pour{' '}
        <strong style={{ color: '#22c55e' }}>analyser, débattre et décider</strong> en connaissance
        de cause sur l'avenir de l'octroi de mer. Voici ce que les données imposent comme
        conclusions.
      </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.65rem' }}>
        {[
          {
            icon: '📋',
            title: 'Transparence des taux',
            desc: 'Publication annuelle consolidée des délibérations régionales sur un portail unique.',
            color: '#7c3aed',
          },
          {
            icon: '🏗️',
            title: 'Réforme ciblée',
            desc: 'Réduire les différentiels >30 pts sur produits courants. Maintenir la protection des productions locales stratégiques.',
            color: '#2563eb',
          },
          {
            icon: '🔄',
            title: 'Diversification fiscale',
            desc: 'Réduire progressivement la dépendance en développant la fiscalité économique locale (CFE, CVAE DOM).',
            color: '#059669',
          },
          {
            icon: '🤝',
            title: 'Négociation EU 2027',
            desc: "Anticiper la renégociation avec un dossier d'impact solide — sans attendre l'expiration du régime actuel.",
            color: '#d97706',
          },
        ].map((r) => (
          <div
      ...
      >
        Données issues de sources officielles vérifiables : DGDDI, IEDOM, INSEE, EUR-Lex, Cour des
        Comptes, Autorité de la concurrence, Rapport Lurel-Hoibian. · Conférence institutionnelle A
        KI PRI SA YÉ v1.0 — Mars 2026.
      </p>
    </div>
  );
}
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://teetee971.github.io/akiprisaye-web/conference-octroi-mer"
        />
        <link
          rel="alternate"
          hrefLang="fr"
      ...
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        >
          ...
          Sources officielles vérifiables : DGDDI, EUR-Lex, IEDOM, Cour des Comptes, Autorité de la
          concurrence, Rapport Lurel-Hoibian · Aucun chiffre inventé ·{' '}
