...
const RECIPES: Recipe[] = [
  // ── Petits-déjeuners ──
  {
    ...
    origine: 'universel',
    ingredients: [
      { name: 'Pain de mie', qty: '6 tranches', prixEst: 0.6, categorie: 'Boulangerie' },
      { name: 'Beurre', qty: '30g', prixEst: 0.35, categorie: 'Crèmerie' },
      { name: 'Café moulu', qty: '15g', prixEst: 0.25, categorie: 'Épicerie' },
      { name: 'Lait', qty: '20cl', prixEst: 0.2, categorie: 'Crèmerie' },
    ],
  ...
  },
  {
    ...
    origine: 'local DOM',
    ingredients: [
      { name: 'Bananes (locales)', qty: '4', prixEst: 0.8, categorie: 'Fruits & Légumes' },
      { name: 'Yaourt nature', qty: '2', prixEst: 0.9, categorie: 'Crèmerie' },
      { name: 'Miel', qty: '2 c.à.s', prixEst: 0.3, categorie: 'Épicerie' },
    ],
    tags: ['local', 'sain'],
  },
  // ── Déjeuners ──
  {
    ...
    origine: 'créole',
    ingredients: [
      { name: 'Poulet entier', qty: '1,5 kg', prixEst: 7.5, categorie: 'Viandes & Poissons' },
      { name: 'Poudre colombo', qty: '2 c.à.s', prixEst: 0.8, categorie: 'Épices' },
      { name: 'Pommes de terre', qty: '500g', prixEst: 1.2, categorie: 'Fruits & Légumes' },
      { name: 'Courgettes', qty: '2', prixEst: 1.0, categorie: 'Fruits & Légumes' },
      { name: 'Riz blanc', qty: '400g', prixEst: 0.9, categorie: 'Épicerie' },
    ],
  ...
  },
  {
    ...
    origine: 'créole',
    ingredients: [
      { name: 'Morue salée', qty: '400g', prixEst: 6.5, categorie: 'Viandes & Poissons' },
      { name: 'Farine', qty: '200g', prixEst: 0.3, categorie: 'Épicerie' },
      { name: 'Avocat', qty: '2', prixEst: 1.8, categorie: 'Fruits & Légumes' },
      { name: 'Oignons', qty: '2', prixEst: 0.6, categorie: 'Fruits & Légumes' },
      { name: 'Piment antillais', qty: '1/2', prixEst: 0.3, categorie: 'Épices' },
      { name: 'Huile de friture', qty: '50cl', prixEst: 1.5, categorie: 'Épicerie' },
      { name: 'Farine de manioc', qty: '100g', prixEst: 0.8, categorie: 'Épicerie' },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Riz blanc', qty: '400g', prixEst: 0.9, categorie: 'Épicerie' },
      { name: 'Haricots rouges (boîte)', qty: '2 boîtes', prixEst: 1.8, categorie: 'Épicerie' },
      { name: 'Lardons', qty: '150g', prixEst: 1.5, categorie: 'Viandes & Poissons' },
      { name: 'Oignons', qty: '1', prixEst: 0.3, categorie: 'Fruits & Légumes' },
      { name: 'Thym, laurier', qty: '1 bouquet', prixEst: 0.4, categorie: 'Herbes' },
    ],
  ...
  },
  {
    ...
    origine: 'local DOM',
    ingredients: [
      { name: 'Dorade / vivaneau', qty: '1,2 kg', prixEst: 11.0, categorie: 'Viandes & Poissons' },
      { name: 'Citron vert', qty: '3', prixEst: 0.6, categorie: 'Fruits & Légumes' },
      { name: 'Piment, ail', qty: 'quelques gousses', prixEst: 0.4, categorie: 'Épices' },
      { name: 'Patate douce', qty: '600g', prixEst: 1.8, categorie: 'Fruits & Légumes' },
      { name: 'Igname', qty: '500g', prixEst: 1.5, categorie: 'Fruits & Légumes' },
    ],
  ...
  },
  {
    ...
    origine: 'créole',
    ingredients: [
      { name: 'Lentilles vertes', qty: '400g', prixEst: 1.6, categorie: 'Épicerie' },
      { name: 'Tomates', qty: '3', prixEst: 1.2, categorie: 'Fruits & Légumes' },
      { name: 'Concombre', qty: '1', prixEst: 0.8, categorie: 'Fruits & Légumes' },
      { name: 'Échalotes', qty: '3', prixEst: 0.5, categorie: 'Fruits & Légumes' },
      { name: 'Vinaigrette', qty: '4 c.à.s', prixEst: 0.4, categorie: 'Épicerie' },
    ],
  ...
  // ── Dîners ──
  {
    ...
    origine: 'local DOM',
    ingredients: [
      { name: 'Christophine', qty: '3', prixEst: 1.5, categorie: 'Fruits & Légumes' },
      { name: 'Fromage râpé', qty: '150g', prixEst: 2.0, categorie: 'Crèmerie' },
      { name: 'Crème fraîche', qty: '20cl', prixEst: 1.4, categorie: 'Crèmerie' },
      { name: 'Jambon cuit', qty: '150g', prixEst: 2.2, categorie: 'Viandes & Poissons' },
      { name: 'Béchamel (farine, beurre, lait)', qty: 'base', prixEst: 0.9, categorie: 'Épicerie' },
    ],
  ...
  },
  {
    ...
    ingredients: [
      {
        name: 'Giraumon (citrouille pays)',
        qty: '1 kg',
        prixEst: 1.5,
        categorie: 'Fruits & Légumes',
      },
      { name: 'Carottes', qty: '3', prixEst: 0.8, categorie: 'Fruits & Légumes' },
      { name: 'Poireaux', qty: '2', prixEst: 0.9, categorie: 'Fruits & Légumes' },
      { name: 'Bouillon cube', qty: '2', prixEst: 0.3, categorie: 'Épicerie' },
      { name: 'Crème de coco', qty: '20cl', prixEst: 1.2, categorie: 'Épicerie' },
    ],
  ...
  },
  {
    ...
    origine: 'créole',
    ingredients: [
      { name: 'Vivaneau / daurade', qty: '1 kg', prixEst: 9.0, categorie: 'Viandes & Poissons' },
      { name: 'Citron vert', qty: '4', prixEst: 0.8, categorie: 'Fruits & Légumes' },
      { name: 'Ail, oignons', qty: '2 gousses + 1', prixEst: 0.4, categorie: 'Épices' },
      { name: 'Piment boisé, thym', qty: 'quelques feuilles', prixEst: 0.2, categorie: 'Herbes' },
      { name: 'Riz blanc', qty: '400g', prixEst: 0.9, categorie: 'Épicerie' },
    ],
  ...
  },
  {
    ...
    origine: 'universel',
    ingredients: [
      { name: 'Œufs', qty: '4', prixEst: 1.2, categorie: 'Crèmerie' },
      { name: 'Poivrons', qty: '2', prixEst: 1.0, categorie: 'Fruits & Légumes' },
      { name: 'Tomates cerises', qty: '100g', prixEst: 0.8, categorie: 'Fruits & Légumes' },
      { name: 'Fromage', qty: '50g', prixEst: 0.8, categorie: 'Crèmerie' },
    ],
...
export default function PlanificateurRepas() {
  ...
  const surcoûts: Record<string, number> = {
    gp: 1.13,
    mq: 1.11,
    gf: 1.17,
    re: 1.12,
      ...
      for (const m of MEALS) {
        ...
        for (const ing of r.ingredients) {
          if (map[ing.name]) {
            ...
            map[ing.name] = {
              qty: ing.qty,
              prixEst: ing.prixEst * (personnes / r.personnes) * surcoeft,
  ...
  const filteredRecipes =
    filterType === 'tous'
      ? RECIPES
      : RECIPES.filter((r) => r.type === (pickingFor?.meal ?? filterType));
  const pickRecipes = pickingFor
    ? RECIPES.filter((r) => r.type === pickingFor.meal)
    : filteredRecipes;

  const plannedCount = DAYS.flatMap((d) => MEALS.map((m) => plan[d][m.id].recipeId)).filter(
    Boolean
  ).length;
      ...
      >
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          >
            ...
            >
              Planifiez vos repas créoles et locaux — liste de courses et budget générés
              automatiquement
            </p>
          </HeroImage>
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <button
                  onClick={() => setPersonnes(Math.max(1, personnes - 1))}
                  style={{
                    width: 28,
                    height: 28,
                    borderRadius: 6,
                ...
                <button
                  onClick={() => setPersonnes(Math.min(8, personnes + 1))}
                  style={{
                    width: 28,
                    height: 28,
                    borderRadius: 6,
            ...
            <div style={{ marginLeft: 'auto', textAlign: 'right' }}>
              <div style={{ fontSize: '0.68rem', color: '#64748b' }}>
                {plannedCount}/21 repas planifiés
              </div>
                ...
                >
                  ...
                  {DAYS.map((day) => {
                    ...
                    return (
                      <button
                        key={day}
                        onClick={() => setPickingFor({ day, meal: m.id })}
                        style={{
                          minHeight: 52,
                          padding: '0.3rem',
                          borderRadius: 8,
                          ...
                          background: recipe ? 'rgba(16,185,129,0.08)' : 'rgba(15,23,42,0.5)',
                          cursor: 'pointer',
                          textAlign: 'left',
                      ...
                      >
                        {recipe ? (
                          <div>
                            ...
                            >
                              {recipe.name.slice(0, 22)}
                              {recipe.name.length > 22 ? '…' : ''}
                            </div>
                            <div
                              style={{ fontSize: '0.58rem', color: '#6b7280', marginTop: '0.1rem' }}
                            >
                              {(recipe.prixPar * personnes * surcoeft).toFixed(2)} €
                            </div>
                          </div>
                        ) : (
                          <div
              ...
              >
                ...
                >
                  <h2 style={{ margin: 0, fontSize: '1rem', fontWeight: 800, color: '#f1f5f9' }}>
                    {MEALS.find((m) => m.id === pickingFor.meal)?.emoji}{' '}
                    {MEALS.find((m) => m.id === pickingFor.meal)?.label} — {pickingFor.day}
                  </h2>
                  <button
                    onClick={() => setPickingFor(null)}
                    style={{
                ...
                {plan[pickingFor.day][pickingFor.meal].recipeId && (
                  <button
                    onClick={() => setRecipe(pickingFor.day, pickingFor.meal, null)}
                    style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {pickRecipes.map((r) => (
                    <button
                      key={r.id}
                      onClick={() => setRecipe(pickingFor.day, pickingFor.meal, r.id)}
                      style={{
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                          ...
                          <span style={{ fontSize: '0.65rem', color: '#10b981', fontWeight: 700 }}>
                            {(r.prixPar * personnes * surcoeft).toFixed(2)} € ({personnes} pers.)
                          </span>
                          <span
                            style={{
                              fontSize: '0.65rem',
                      ...
                      .map(
                        (cat) =>
                          `${cat}:\n${Object.entries(shoppingList)
                            ...
                            .map(
                              ([name, v]) => `  - ${name} (${v.qty}) — ~${v.prixEst.toFixed(2)} €`
                            )
                            .join('\n')}`
                      )
                      .join('\n\n');
                    ...
                    .map(([name, v]) => (
                      ...
                      >
                        <span style={{ fontSize: '0.8rem', color: '#e2e8f0' }}>
                          {name}{' '}
                          <span style={{ color: '#64748b', fontSize: '0.7rem' }}>({v.qty})</span>
                        </span>
