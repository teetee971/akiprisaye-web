        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-5 space-y-5">
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <ul className="list-disc list-inside text-slate-200 space-y-2">
              ...
              <li>
                Financement neutre : aucune publicité ni partenariat commercial associé aux données.
              </li>
              <li>
                Responsabilité éditoriale assumée : chaque publication est relue avant mise en
                ligne.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <ul className="list-disc list-inside text-slate-200 space-y-2">
              ...
              <li>
                Pas d&apos;engagement automatique de mise à jour : chaque itération est annoncée.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <ul className="list-disc list-inside text-slate-200 space-y-2">
              ...
              <li>
                Protection des personnes : aucune donnée personnelle collectée pour consulter.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <ul className="list-disc list-inside text-slate-200 space-y-2">
              ...
              <li>
                Qui valide : un binôme relecteur vérifie chaque fichier et sa source avant
                diffusion.
              </li>
              <li>
                Qui corrige : toute personne peut signaler une erreur, les corrections sont tracées
                publiquement.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-slate-200">
              Les contenus publiés relèvent d&apos;une initiative citoyenne. Ils peuvent être cités
              par les médias, associations et collectivités, avec mention de la source. Toute
              correction ou précision peut être demandée via la page Contact.
            </p>
          </section>
        </div>
      </div>
