...
function getOperatorUrl(operatorName: string, url?: string): string {
  ...
  return buildBookingUrl(base, 'comparateur-internet');
}
                  ...
                  <>
                    ...
                    <div className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-5">
                      ...
                      <div className="grid sm:grid-cols-3 gap-4">
                        ...
                        {(() => {
                          const withDebit = [...sortedResults].sort((a, b) => {
                            const numA = parseFloat(
                              a.debitDescendant?.replace(/[^0-9.]/g, '') || '0'
                            );
                            const numB = parseFloat(
                              b.debitDescendant?.replace(/[^0-9.]/g, '') || '0'
                            );
                            return numB - numA;
                          });
                        ...
                        {/* Sans engagement */}
                        {(() => {
                          const noCommitment = sortedResults.filter(
                            (r) =>
                              r.engagement?.toLowerCase().includes('sans') ||
                              r.engagement?.toLowerCase().includes('aucun')
                          );
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-gray-400 space-y-2">
                    <p>
                      ...
                      sur des observations publiques citoyennes. Les prix affichés sont indicatifs
                      et peuvent varier selon les promotions et conditions réelles.
                    </p>
                    <p>
                      <strong className="text-gray-300">Méthode de comparaison :</strong> Les
                      résultats sont triés par prix mensuel croissant, puis par date de relevé (les
                      plus récents en premier). Les débits annoncés peuvent différer des débits
                      réels constatés.
                    </p>
                    <p>
                      <strong className="text-gray-300">Limites :</strong> Les prix affichés ne
                      tiennent pas compte des promotions temporaires, des frais d'installation, ni
                      des conditions d'éligibilité spécifiques à chaque offre. Vérifiez toujours
                    ...
                    <p>
                      ...
                      vente de chaque opérateur pour obtenir les informations officielles et à jour.
                    </p>
                  </div>
                </div>
              </div>
