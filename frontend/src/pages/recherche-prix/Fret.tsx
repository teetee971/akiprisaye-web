        ...
        <div className="space-y-6">
          ...
          <section className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-5">
            <form onSubmit={handleSearch} className="space-y-4">
              {/* Port de départ */}
              <div>
                <label htmlFor="portDepart" className="block text-sm font-medium text-gray-300 mb-2">
                  Port de départ
                </label>
                <select
                  id="portDepart"
              ...
              {/* Port d'arrivée */}
              <div>
                <label htmlFor="portArrivee" className="block text-sm font-medium text-gray-300 mb-2">
                  Port d'arrivée
                </label>
                <select
                  id="portArrivee"
              ...
              {/* Type de transport */}
              <div>
                <label htmlFor="typeTransport" className="block text-sm font-medium text-gray-300 mb-2">
                      ...
                      <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-sm text-blue-300">
                            ...
                            représentent une part significative du prix final des produits importés
                            dans les DOM. Plus la distance est grande, plus l'impact est important.
                          </p>
                        </div>
                      </div>
                    )}
          ...
          <section className="bg-gradient-to-r from-slate-900/50 to-slate-800/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-6">
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <div className="p-4 bg-slate-800/30 rounded-lg">
                <h4 className="font-semibold text-gray-200 mb-2">📦 Dépendance aux importations</h4>
              ...
              <div className="p-4 bg-slate-800/30 rounded-lg">
                <h4 className="font-semibold text-gray-200 mb-2">🌍 Effet du volume et de l'éloignement</h4>
                <p className="text-gray-400">
                  Plus la distance entre le port de départ (généralement en métropole ou en Europe)
                  et le port d'arrivée DOM est grande, plus les coûts de fret augmentent. Le volume
                  des échanges commerciaux et la fréquence des rotations influencent également
                  directement les tarifs pratiqués par les opérateurs logistiques.
                </p>
              </div>

              <div className="p-4 bg-slate-800/30 rounded-lg">
                <h4 className="font-semibold text-gray-200 mb-2">⚖️ Différences DOM / Métropole</h4>
                <p className="text-gray-400">
                  Les coûts de fret maritime ajoutent une surcharge significative par rapport aux
                  prix pratiqués en métropole pour les mêmes produits. Cette surcharge se répercute
                  sur l'ensemble de la chaîne de distribution et contribue aux écarts de prix
                  constatés entre la métropole et les DOM.
                </p>
              </div>

              <div className="p-4 bg-slate-800/30 rounded-lg">
                <h4 className="font-semibold text-gray-200 mb-2">🚢 Rôle des ports et de la logistique</h4>
                <p className="text-gray-400">
                  Les infrastructures portuaires, les capacités de stockage, la disponibilité des
                  conteneurs, et l'efficacité de la chaîne logistique locale jouent un rôle crucial.
                  Les délais d'acheminement, les formalités douanières, et les coûts de manutention
                  s'ajoutent au coût du transport maritime lui-même.
                </p>
              </div>
              ...
              <div className="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                <p className="text-sm text-yellow-300">
                  ...
                  constituent pas une estimation de l'impact sur votre panier de consommation.
                  De nombreux autres facteurs (taxes, marges commerciales, coûts de distribution
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm text-gray-400 space-y-2">
                  <p>
                    ...
                    basées sur les tarifs publics des ports, les rapports des autorités maritimes,
                    et les observations des opérateurs logistiques. Les coûts affichés sont
                    indicatifs et peuvent varier selon la saison, le volume, et les conditions
                    contractuelles.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    logistique. Les frais portuaires, les assurances, les taxes douanières, et
                    les coûts de distribution locale ne sont pas inclus. Aucun calcul automatique
                    de l'impact sur les prix à la consommation n'est proposé.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    générales des opérateurs logistiques pour obtenir des devis officiels et à jour.
                  </p>
                </div>
              </div>
            </div>
