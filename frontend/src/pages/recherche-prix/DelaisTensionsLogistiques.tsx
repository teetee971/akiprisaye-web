...
const DelaisTensionsLogistiques: React.FC = () => {
  ...
  const observationsByTerritory = observations.reduce(
    (acc, obs) => {
      ...
      <div className="min-h-screen bg-slate-950 pb-12">
          ...
          <div className="bg-orange-950/30 border-l-4 border-orange-500 p-4 rounded-r-lg">
            <div className="flex items-start">
              ...
              <div className="text-sm text-orange-200">
                ...
                <p>
                  Ce module présente des <strong>observations historiques</strong> des délais et
                  tensions logistiques ayant affecté l'acheminement des marchandises vers les DOM.
                </p>
                <p className="mt-2">
                  <strong>
                    Il ne constitue ni une prévision, ni une analyse économique, ni une attribution
                    de responsabilité.
                  </strong>
                </p>
              </div>
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <div>
                ...
                <p>
                  ...
                  ayant affecté les délais d'acheminement des marchandises vers les territoires
                  ultramarins.
                </p>
              </div>
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 mt-4">
                ...
                <p className="text-xs text-gray-300">
                  <strong>Observation ≠ Prévision</strong> — Ces données décrivent des événements
                  passés et ne permettent pas de prédire les situations futures.
                </p>
                <p className="text-xs text-gray-300 mt-2">
                  <strong>Information ≠ Explication des prix</strong> — Les tensions logistiques
                  sont l'un des nombreux facteurs pouvant affecter l'approvisionnement, mais ce
                  module ne calcule pas leur impact économique.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          {Object.entries(observationsByTerritory).map(([territoryCode, territoryObs]) => (
            <div
              key={territoryCode}
              className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-6"
            >
              ...
              <div className="space-y-4">
                {territoryObs.map((obs, index) => (
                  <div
                    key={`${obs.territory}-${obs.period}-${obs.transport_type}-${index}`}
                  ...
                  >
                    ...
                    <div className="mb-3">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getDelayLevelColor(obs.delay_level)}`}
                      >
                    ...
                    {/* Description */}
                    <p className="text-sm text-gray-300 mb-3">{obs.description}</p>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {obs.nature_tension.map((tension, i) => (
                          <span
                            key={i}
                            className="inline-flex items-center px-2 py-1 bg-orange-900/30 text-orange-300 text-xs rounded border border-orange-700"
                          >
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 mt-2">
                            Publication :{' '}
                            {new Date(obs.date_publication).toLocaleDateString('fr-FR', {
                              year: 'numeric',
                              month: 'long',
                              day: 'numeric',
                            })}
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <div>
                <h3 className="font-semibold text-gray-100 mb-2">
                  Pourquoi documenter ces événements ?
                </h3>
                <p>
                  Les territoires ultramarins, de par leur{' '}
                  <strong>éloignement et leur insularité</strong>, sont particulièrement exposés aux
                  perturbations des chaînes logistiques mondiales. Documenter ces événements passés
                  permet de mieux comprendre les réalités structurelles de l'approvisionnement des
                  DOM.
                </p>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-gray-100 mb-2">
                  Facteurs observés historiquement
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-slate-800/50 rounded p-3">
                    <h4 className="font-semibold text-gray-200 text-xs mb-2">
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="bg-slate-800/50 rounded-lg p-4 text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Observations historiques • Aucune prévision • Aucune valeur contractuelle • Aucun
              tracking
            </p>
          </div>
        </div>
