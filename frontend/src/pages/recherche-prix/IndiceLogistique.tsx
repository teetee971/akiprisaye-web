        ...
        <div className="max-w-4xl mx-auto px-4 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">{profile.territoryName}</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Modes de transport</h3>
            
            <div className="space-y-4">
              {/* Maritime */}
              <div className="flex items-start">
                <Ship className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <span className="font-medium text-gray-900">Transport maritime</span>
              ...
              {/* Aérien */}
              <div className="flex items-start">
                <Plane className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <span className="font-medium text-gray-900">Transport aérien</span>
                    <span className="text-sm font-semibold text-blue-600 capitalize">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Exposition aux risques</h3>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <h3 className="text-sm font-bold text-gray-900 mb-3">Sources publiques</h3>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Qu'est-ce que l'Indice Logistique DOM ?</h3>
              <p>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Ce que l'indice N'EST PAS :</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Ce que l'indice PERMET :</h3>
              <ul className="space-y-1 ml-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Pourquoi ces informations ?</h3>
              <p>
