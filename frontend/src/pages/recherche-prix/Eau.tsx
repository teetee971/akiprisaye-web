        ...
        <header className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700">
          <div className="max-w-7xl mx-auto px-4 py-6">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-gray-100">Prix de l'eau</h1>
            </div>
                        ...
                        <table className="w-full">
                          ...
                          <tbody className="divide-y divide-slate-700/50">
                            {sortedResults.map((result, index) => (
                              <tr
                                key={`${result.organismeGestionnaire}-${result.typeService}-${index}`}
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-gray-400 space-y-2">
                    <p>
                      ...
                      sur les rapports publics des offices de l'eau, des régies municipales, et des
                      syndicats d'eau. Les prix affichés sont indicatifs et peuvent varier selon la
                      consommation et les options tarifaires.
                    </p>
                    <p>
                      <strong className="text-gray-300">Méthode de comparaison :</strong> Les
                      résultats sont triés par prix au m³ croissant, puis par date de relevé (les
                      plus récents en premier). Les tarifs incluent la part fixe (abonnement) et la
                      part variable (prix au m³).
                    </p>
                    <p>
                      <strong className="text-gray-300">Limites :</strong> Les prix affichés ne
                      constituent pas une simulation de facture. La consommation réelle, les
                      redevances, et les taxes locales peuvent modifier significativement le montant
                      final. Aucune estimation personnalisée n'est proposée.
                    </p>
                    <p>
                      ...
                      commission des gestionnaires d'eau et n'avons aucun partenariat commercial.
                    </p>
                    <p>
                      <strong className="text-gray-300">Données indicatives :</strong> Les prix ne
                      constituent pas une offre contractuelle. Consultez les conditions générales de
                      service de chaque gestionnaire pour obtenir les informations officielles et à
                      jour.
                    </p>
                    <p>
