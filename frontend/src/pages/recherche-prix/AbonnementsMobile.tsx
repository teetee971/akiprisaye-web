              ...
              <>
                {results.length > 0 ? (
                  <>
                    {/* Price Summary */}
                    <section className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-5">
                      <h2 className="text-lg font-semibold text-gray-100 mb-3">Résumé des prix</h2>
                    ...
                    <section className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-5">
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            {sortedResults.map((plan, index) => (
                              <tr
                                key={`${plan.operateur}-${plan.donnees}-${plan.typeOffre}-${index}`}
                              ...
                              >
                                ...
                                <td className="py-3 px-2 text-gray-300">{plan.appelsSMS}</td>
                      ...
                      <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                        <p className="text-xs text-blue-200">
                          <strong>Prix observé</strong> — Ce ne sont PAS des prix garantis. Les
                          tarifs peuvent varier selon promotions et conditions.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="bg-slate-900/50 backdrop-blur-md rounded-xl border border-slate-700/50 p-5">
                      ...
                      <div className="grid sm:grid-cols-3 gap-4">
                        ...
                        {(() => {
                          const withData = [...sortedResults].sort((a, b) => {
                            const numA = parseFloat(
                              String(a.donnees).replace(/[^0-9.]/g, '') || '0'
                            );
                            const numB = parseFloat(
                              String(b.donnees).replace(/[^0-9.]/g, '') || '0'
                            );
                            return numB - numA;
                          });
                          ...
                          return (
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                              ...
                              <p className="text-xs text-gray-400">
                                {formatPrice(best.prixMensuel)}/mois
                              </p>
                              <a
                                href={getOperatorUrl(best.operateur)}
                                target="_blank"
                        ...
                        {(() => {
                          if (!sortedResults.length) return null;
                          const best =
                            sortedResults[Math.floor(sortedResults.length / 2)] || sortedResults[0];
                          return (
                            <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
                              ...
                              <p className="text-xs text-gray-400 mt-1">
                                Recommandé pour les voyages entre DOM
                              </p>
                              <a
                                href={getOperatorUrl(best.operateur)}
                                target="_blank"
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-xs text-gray-300">
                    <p>
                      <strong>Sources</strong> — Les prix affichés proviennent d'observations
                      citoyennes publiques et de données publiques des opérateurs. Aucune garantie
                      de disponibilité ou d'exactitude.
                    </p>

                    <p>
                      <strong>Méthode de comparaison</strong> — Les forfaits sont triés par prix
                      mensuel croissant, puis par date de relevé. Seuls les forfaits observés
                      récemment sont affichés.
                    </p>

                    <p>
                      <strong>Limites</strong> — Les prix affichés ne tiennent pas compte des
                      promotions temporaires, des frais d'activation, ni des conditions spécifiques
                      (engagement, frais de résiliation, options payantes).
                    </p>

                    <p>
                      <strong>Aucune affiliation</strong> — A KI PRI SA YÉ ne reçoit aucune
                      commission des opérateurs mobiles. Comparaison neutre et indépendante.
                    </p>

                    <p>
                      <strong>Données indicatives</strong> — Cet outil est destiné à l'information
                      et à la comparaison. Il ne remplace pas une consultation des offres
                      officielles auprès des opérateurs.
                    </p>
