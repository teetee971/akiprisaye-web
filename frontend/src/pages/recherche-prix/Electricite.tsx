        ...
        <header className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700">
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-gray-100">Prix de l'électricité</h1>
            </div>
                        ...
                        <table className="w-full">
                          ...
                          <tbody className="divide-y divide-slate-700/50">
                            {sortedResults.map((result, index) => (
                              <tr
                                key={`${result.fournisseur}-${result.typeTarif}-${index}`}
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-gray-400 space-y-2">
                    <p>
                      ...
                      sur les tarifs réglementés publiés par la CRE (Commission de Régulation de
                      l'Énergie), EDF, et les autorités locales. Les prix affichés sont indicatifs
                      et peuvent varier selon les options tarifaires.
                    </p>
                    <p>
                      <strong className="text-gray-300">Méthode de comparaison :</strong> Les
                      résultats sont triés par prix du kWh croissant, puis par date de relevé (les
                      plus récents en premier). Les tarifs réglementés sont fixés par les pouvoirs
                      publics.
                    </p>
                    <p>
                      <strong className="text-gray-300">Limites :</strong> Les prix affichés ne
                      constituent pas une simulation de facture. La consommation réelle, les taxes
                      locales, et les options tarifaires peuvent modifier significativement le
                      montant final. Aucune estimation personnalisée n'est proposée.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      vente de chaque fournisseur pour obtenir les informations officielles et à
                      jour.
                    </p>
                  </div>
                </div>
