        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 shadow-lg mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              plusieurs facteurs structurels. Cette page vous aide à comprendre ces différences de
          ...
          <div className="bg-slate-900 rounded-2xl p-6 shadow-lg mb-8">
            ...
            <p className="text-gray-400 text-sm mb-5">
              Écart moyen des prix alimentaires par rapport à la France métropolitaine. Source :{' '}
              <span className="italic">
                INSEE — Enquête Budget de famille DOM 2017/2018 ; IEDOM Rapports annuels 2023.
              </span>
            </p>
            <div className="space-y-3">
              {PRICE_GAP_DATA.map((t) => (
                <div key={t.territory} className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-sm font-semibold w-14 text-right ${t.gap >= 20 ? 'text-red-400' : t.gap >= 15 ? 'text-orange-400' : 'text-amber-400'}`}
                  >
                    +{t.gap} %
                  </span>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-300 text-sm mb-3">
                Le transport par bateau ou avion depuis l'Hexagone représente un coût important.
                Plus la distance et la durée d'acheminement sont élevées, plus l'impact sur le prix
                final est fort.
              </p>
              ...
              <div className="p-3 bg-blue-900/20 border border-blue-700/30 rounded-lg">
                <p className="text-blue-200 text-xs">
                  <strong>Source :</strong> Armateurs de France – Rapport activité 2023 ; IEDOM
                  Rapports annuels.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-300 text-sm mb-3">
                L'octroi de mer est une taxe douanière perçue sur les marchandises importées dans
                les DROM. Elle finance en moyenne <strong className="text-white">35 à 40 %</strong>{' '}
                des budgets des collectivités locales et protège la production locale.
              </p>
              <div className="space-y-1 mb-3">
                <div className="flex justify-between text-xs text-gray-400">
                  <span>Produits alimentaires de base (riz, pâtes…)</span>
                  <span className="text-purple-300 font-medium">0–2 %</span>
                </div>
                <div className="flex justify-between text-xs text-gray-400">
                  <span>Produits laitiers, boissons</span>
                  <span className="text-purple-300 font-medium">5–10 %</span>
                </div>
                <div className="flex justify-between text-xs text-gray-400">
                  <span>Produits manufacturés, électronique</span>
              ...
              <div className="p-3 bg-purple-900/20 border border-purple-700/30 rounded-lg">
                <p className="text-purple-200 text-xs">
                  <strong>Source :</strong> DGDDI — Douane française ; Code des douanes de l'Union
                  (UCC) ; Règlement UE 2022/2 prorogeant l'octroi de mer jusqu'en 2030.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-300 text-sm mb-3">
                ...
                l'humidité tropicale et les risques naturels (cyclones, séismes) augmentent les
                coûts d'exploitation et d'assurance.
              </p>
              <div className="p-3 bg-green-900/20 border border-green-700/30 rounded-lg">
                <p className="text-green-200 text-xs">
                  <strong>Impact estimé :</strong> +5 % à +15 % selon le territoire et le type de
                  produit. Source : Autorité de la concurrence — avis 09-A-45 (Antilles) et rapports
                  sectoriels.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-300 text-sm mb-3">
                Les petits volumes de vente réduisent les économies d'échelle et limitent la
                concurrence entre distributeurs. La Guadeloupe compte environ{' '}
                <strong className="text-white">42</strong> grandes surfaces pour 377 000 habitants
                (contre ~2 200 en France métropolitaine pour 68 M d'habitants).
              </p>
              <div className="p-3 bg-orange-900/20 border border-orange-700/30 rounded-lg">
                <p className="text-orange-200 text-xs">
                  <strong>Impact estimé :</strong> +10 % à +25 % selon le territoire. Source :
                  Autorité de la concurrence ; INSEE — Enquête sur la structure du commerce de
                  détail.
                </p>
              </div>
            </div>
          ...
          <div className="bg-slate-900 rounded-2xl p-6 shadow-lg mb-8">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Le surcoût de la vie est d'autant plus lourd que les revenus dans les DROM sont
              inférieurs à ceux de la métropole. Selon l'INSEE (2023), le revenu disponible médian
              par unité de consommation s'établit à :
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4">
              {[
                ...
                <div
                  key={item.label}
                  className={`p-3 rounded-xl border ${item.color} bg-slate-800/50`}
                >
            ...
            <p className="text-xs text-gray-500">
              ...
              Le sursalaire de la fonction publique (+40 % à +53 %) compense partiellement le
              surcoût, mais il ne bénéficie pas aux salariés du privé (environ 70 % des actifs).
            </p>
          </div>
          ...
          <div className="bg-slate-900 rounded-2xl p-6 shadow-lg mb-8">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                Notre plateforme compare les prix d'un même produit (identifié par son code-barres
                EAN) entre différents territoires et enseignes. Voici notre méthodologie :
              </p>

              <ol className="list-decimal list-inside space-y-2 ml-4">
                <li className="text-sm">
                  <strong className="text-white">Identification du produit :</strong> Chaque produit
                  est identifié de manière unique par son code EAN-13.
                </li>
                <li className="text-sm">
              ...
              <div className="p-4 bg-blue-900/20 border border-blue-700/30 rounded-lg mt-4">
                <p className="text-blue-200 text-sm">
                  <strong>Exemple :</strong> Un produit coûte 3,50 € en Guadeloupe et 2,80 € en
                  France métropolitaine. L'écart est de <strong>+25 %</strong> (0,70 € de
                  différence).
                </p>
              </div>
            </div>
          ...
          <div className="bg-slate-900 rounded-2xl p-6 shadow-lg border-l-4 border-yellow-500 mb-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Important à savoir</h3>
                <ul className="space-y-2 text-gray-300 text-sm">
                  <li>
                    • Les prix peuvent varier selon les enseignes, les périodes et les promotions.
                  </li>
                  <li>
                    • Les données affichées proviennent de relevés citoyens ou de sources
                    officielles.
                  </li>
                  <li>
