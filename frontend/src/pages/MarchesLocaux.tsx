...
import {
  MapPin, Search, Clock, ArrowLeft, Calendar,
  Star, ChevronRight,
} from 'lucide-react';
...
const MARCHES: Marche[] = [
  // ── GUADELOUPE ──
  {
    ...
    produits: ['Légumes pays', 'Fruits tropicaux', 'Épices créoles', 'Poissons frais', 'Rhum artisanal', 'Bokit chaud'],
    note: 4.7, nbAvis: 312,
    type: 'couvert',
    description: 'Le plus grand marché couvert de Guadeloupe. Atmosphère authentique créole, spécialités régionales introuvables en grande surface.',
    image: 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gp-capesterre',
    ...
    produits: ['Manioc frais', 'Ignames', 'Giraumon', 'Christophines', 'Herbes aromatiques', 'Viandes locales'],
    note: 4.5, nbAvis: 87,
    type: 'forain',
    description: 'Marché forain bi-hebdomadaire avec présence de producteurs locaux directs. Très bons prix sur les légumes racines.',
    image: 'https://images.unsplash.com/photo-1484663020049-bf87a22cc2d7?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gp-marie-galante',
    ...
    produits: ['Rhum agricole Marie-Galante', 'Sucre de canne artisanal', 'Confitures', 'Légumes', 'Épices'],
    note: 4.8, nbAvis: 53,
    type: 'forain',
    description: 'Le marché dominical de l\'île du Soleil. Incontournable pour le rhum AOC et les produits sucrerie de Marie-Galante.',
    image: 'https://images.unsplash.com/photo-1567306295427-94503f8300d7?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  ...
  // ── MARTINIQUE ──
  {
    ...
    note: 4.6, nbAvis: 425,
    type: 'couvert',
    description: 'Grand marché couvert historique de Fort-de-France. Ambiance unique, couleurs vives. Spécialités martiniquaises authentiques.',
    image: 'https://images.unsplash.com/photo-1563906267088-b029e7101114?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'mq-saintpierre',
    ...
    note: 4.8, nbAvis: 144,
    type: 'producteurs',
    description: 'Marché de producteurs dominical en bord de mer, avec vue sur la Montagne Pelée. Qualité exceptionnelle.',
  ...
  // ── LA RÉUNION ──
  {
    ...
    produits: ['Vanille Bourbon', 'Curcuma péi', 'Miel Bourbon', 'Bichiques (saison)', 'Fruits de Saison', 'Rougails préparés'],
    note: 4.7, nbAvis: 198,
    type: 'forain',
    description: 'Grand marché populaire de Saint-Denis. Spécialités créoles réunionnaises, nombreux producteurs du sud et de l\'intérieur.',
    image: 'https://images.unsplash.com/photo-1567306295427-94503f8300d7?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 're-stpierre',
    ...
    produits: ['Lentilles de Cilaos', 'Grains de café Bourbon', 'Fleurs tropicales', 'Légumes bio', 'Tisanes'],
    note: 4.6, nbAvis: 231,
    type: 'couvert',
    description: 'Marché emblématique du sud de La Réunion. Halle couverte, ambiance festive le week-end.',
    image: 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 're-nocturne-fdf',
    ...
    produits: ['Samoussas', 'Bouchons', 'Carry poulet emporté', 'Jus de fruits tropicaux', 'Artisanat local'],
    note: 4.5, nbAvis: 167,
    type: 'nocturne',
    description: 'Marché nocturne en bord de mer. Ambiance créole détendue, street food réunionnaise et artisanat.',
  ...
  // ── GUYANE ──
  {
    ...
    produits: ['Couac manioc', 'Poivrons locaux', 'Crevettes d\'élevage', 'Plantes médicinales amérindiennes', 'Cachiri (saison)'],
    note: 4.4, nbAvis: 112,
    type: 'couvert',
    description: 'Marché multiculturel reflétant la diversité guyanaise. Créoles, Bushinengués, Amérindiens, Brésiliens — tous présents.',
    image: 'https://images.unsplash.com/photo-1484663020049-bf87a22cc2d7?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gf-stlaurent',
    ...
    note: 4.7, nbAvis: 67,
    type: 'forain',
    description: 'Marché frontière Guyane–Suriname. Échanges culturels uniques, produits rares des forêts amazoniennes.',
  ...
  // ── MAYOTTE ──
  {
    ...
    produits: ['Ylang-ylang frais', 'Poissons tropicaux', 'Riz vrac', 'Épices de Mayotte', 'Manioc', 'Tisanes mahoraises'],
    note: 4.2, nbAvis: 89,
    type: 'couvert',
    description: 'Le marché central de Grande-Terre. Ambiance animée 7j/7, produits de l\'île et d\'importation. Prix accessibles.',
    image: 'https://images.unsplash.com/photo-1563906267088-b029e7101114?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
];
...
const TYPE_LABEL: Record<Marche['type'], { label: string; cls: string }> = {
  ...
  nocturne:    { label: 'Marché nocturne', cls: 'bg-purple-500/15 text-purple-400 border-purple-500/30' },
  producteurs: { label: 'Producteurs directs', cls: 'bg-green-500/15 text-green-400 border-green-500/30' },
};
    ...
    <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl overflow-hidden hover:border-blue-500/40 transition-all">
      ...
      <div className="relative h-40 overflow-hidden">
        ...
        <div className="absolute bottom-2 left-3 right-3">
          ...
          <p className="text-blue-300 text-xs">{m.ville} · {m.territoire}</p>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mb-2">
          {[1, 2, 3, 4, 5].map(i => (
            <Star key={i} className={`w-3 h-3 ${i <= Math.round(m.note) ? 'text-amber-400 fill-amber-400' : 'text-slate-600'}`} />
          ))}
        ...
        <div className="flex flex-wrap gap-1">
          {m.produits.slice(0, 4).map(p => (
            <span key={p} className="text-xs bg-blue-900/30 border border-blue-700/40 text-blue-300 px-2 py-0.5 rounded-full">{p}</span>
          ))}
          {m.produits.length > 4 && (
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        ...
        <link rel="alternate" hrefLang="fr" href="https://teetee971.github.io/akiprisaye-web/marches-locaux" />
        <link rel="alternate" hrefLang="x-default" href="https://teetee971.github.io/akiprisaye-web/marches-locaux" />
      </Helmet>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16 pt-6">
        ...
        <div className="mb-4 flex flex-wrap gap-3">
          ...
          <Link to="/producteurs-locaux" className="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-green-300 transition-colors">
            🌾 Producteurs locaux
          </Link>
        </div>
        ...
        <div className="mb-6">
          ...
          >
            ...
            <h1 className="text-2xl sm:text-4xl font-black text-white drop-shadow leading-tight">
              📍 Marchés locaux<br />des DOM
            </h1>
            <p className="text-blue-100 text-sm mt-2 drop-shadow max-w-2xl">
              Découvrez les marchés près de chez vous — horaires, produits locaux, jours d'ouverture.
            </p>
        ...
        <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-4 mb-6 space-y-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {jourActif && (
              <button onClick={() => setJourActif(null)} className="text-xs text-slate-500 hover:text-slate-300 underline underline-offset-2">
                Effacer
              </button>
            )}
          </div>
        ...
        <p className="text-sm text-slate-400 mb-4">
          <span className="font-semibold text-white">{filtered.length}</span> marché{filtered.length > 1 ? 's' : ''} trouvé{filtered.length > 1 ? 's' : ''}
        </p>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-16 text-slate-500">
            ...
            <button onClick={() => { setSearch(''); setTerritoire('Tous'); setJourActif(null); }}
