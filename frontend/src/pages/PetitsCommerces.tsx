...
const COMMERCES: Commerce[] = [
  ...
  {
    id: 'gc-001',
    nom: 'Épicerie Ti Bò Kay',
    categorie: 'Épicerie',
    categorieIcon: ShoppingBag,
    categorieColor: 'text-amber-400 bg-amber-400/10',
    territoire: 'Guadeloupe',
    ville: 'Pointe-à-Pitre',
    adresse: '12 Rue Frébault',
    telephone: '0590 82 14 77',
    horaires: 'Lun–Sam 7h–19h · Dim 7h–13h',
    ...
    local: true,
    description:
      'Épicerie créole de quartier depuis 1978. Spécialiste des produits du terroir guadeloupéen.',
    image:
      'https://images.unsplash.com/photo-1534723452862-4c874018d66d?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gc-002',
    nom: 'Boulangerie Dorée des Antilles',
    categorie: 'Boulangerie',
    categorieIcon: Coffee,
    categorieColor: 'text-orange-400 bg-orange-400/10',
    territoire: 'Guadeloupe',
    ville: 'Basse-Terre',
    adresse: '5 Avenue du Général de Gaulle',
    telephone: '0590 81 22 33',
    horaires: 'Mar–Dim 5h30–13h',
    ...
    local: true,
    description:
      'Artisan boulanger depuis 3 générations. Pain au levain naturel et pâtisseries créoles.',
    image:
      'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gc-003',
    nom: 'Boucherie Chez Rosette',
    categorie: 'Boucherie',
    categorieIcon: Utensils,
    categorieColor: 'text-red-400 bg-red-400/10',
    territoire: 'Guadeloupe',
    ville: 'Capesterre-Belle-Eau',
    adresse: 'Marché Municipal, Stand 7',
    telephone: '0590 86 41 05',
    horaires: 'Mar · Jeu · Sam 6h–12h',
    ...
    image:
      'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gc-004',
    nom: 'Quincaillerie Zoreilles',
    categorie: 'Quincaillerie',
    categorieIcon: Wrench,
    categorieColor: 'text-slate-400 bg-slate-400/10',
    territoire: 'Guadeloupe',
    ville: 'Les Abymes',
    adresse: '88 Route de Chauvel',
    telephone: '0590 90 55 12',
    ...
    local: false,
    description:
      'Tout pour vos travaux. Conseil personnalisé, livraison possible sur grand Basse-Terre.',
    image:
      'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gc-005',
    nom: 'Pharmacie du Bourg',
    categorie: 'Pharmacie',
    categorieIcon: Pill,
    ...
    telephone: '0590 88 11 34',
    horaires: 'Lun–Sam 8h–19h · Sam 8h–12h30',
    ...
    local: false,
    description:
      'Pharmacie de proximité. Équipe attentionnée, conseil en phytothérapie antillaise.',
    image:
  ...
  // ── MARTINIQUE ──
  {
    ...
    telephone: '0596 78 22 44',
    horaires: 'Lun–Sam 7h–19h · Dim 8h–13h',
    ...
    local: true,
    description:
      "Épicerie fine spécialisée en produits martiniquais d'exception. Idéale pour les cadeaux.",
    image:
      'https://images.unsplash.com/photo-1601598851547-4302969d0614?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'mq-002',
    nom: 'Traiteur Manman Mijo',
    categorie: 'Traiteur',
    categorieIcon: Utensils,
    categorieColor: 'text-pink-400 bg-pink-400/10',
    territoire: 'Martinique',
    ville: 'Le Lamentin',
    adresse: '15 Rue du Centre',
    telephone: '0596 51 09 87',
    horaires: 'Lun–Ven 10h–18h · Sam 9h–14h',
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'mq-004',
    nom: 'Salon Tresses & Beauté',
    categorie: 'Coiffure',
    categorieIcon: Scissors,
    categorieColor: 'text-purple-400 bg-purple-400/10',
    territoire: 'Martinique',
    ville: 'Sainte-Marie',
    adresse: '22 Rue du Marché',
    telephone: '0596 69 48 73',
    ...
    local: true,
    description:
      'Spécialiste des cheveux afro. Produits 100% naturels, soins à base de plantes créoles.',
    image:
      'https://images.unsplash.com/photo-1560869713-7d0a29430803?auto=format&fm=webp&fit=crop&w=800&q=80',
  },

  // ── LA RÉUNION ──
  {
    id: 're-001',
    nom: 'Épicerie Péi Zot',
    categorie: 'Épicerie',
    categorieIcon: ShoppingBag,
    categorieColor: 'text-amber-400 bg-amber-400/10',
    ...
    telephone: '0262 21 33 58',
    horaires: 'Lun–Sam 6h30–19h30 · Dim 7h–12h30',
    ...
    local: true,
    description:
      "Épicerie 100% Réunion. Jean-Paul sélectionne uniquement des producteurs de l'île.",
    image:
      'https://images.unsplash.com/photo-1543168256-418811576931?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 're-002',
    nom: 'Boucherie Charcuterie Bardot',
    categorie: 'Boucherie',
    categorieIcon: Utensils,
    categorieColor: 'text-red-400 bg-red-400/10',
    territoire: 'La Réunion',
    ville: 'Saint-Pierre',
    adresse: 'Marché de Saint-Pierre, Allée B',
    telephone: '0262 25 87 41',
    horaires: 'Mar · Jeu · Sam · Dim 5h30–12h',
  ...
  {
    id: 're-003',
    nom: 'Pharmacie Altitude Cilaos',
    categorie: 'Pharmacie',
    categorieIcon: Pill,
    categorieColor: 'text-green-400 bg-green-400/10',
    territoire: 'La Réunion',
    ville: 'Cilaos',
    adresse: 'Rue Mac-Auliffe',
    telephone: '0262 31 72 08',
    horaires: 'Lun–Sam 8h–12h30 · 14h–18h30',
    ...
    local: false,
    description:
      'Seule pharmacie des cirques. Service essentiel pour les randonneurs et résidents.',
    image:
      'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  ...
  {
    id: 'gf-001',
    nom: 'Épicerie Creole Way',
    categorie: 'Épicerie',
    categorieIcon: ShoppingBag,
    categorieColor: 'text-amber-400 bg-amber-400/10',
    territoire: 'Guyane',
    ville: 'Cayenne',
    adresse: '44 Avenue du Général de Gaulle',
    telephone: '0594 31 02 67',
    horaires: 'Lun–Sam 7h–20h · Dim 8h–14h',
    ...
    local: true,
    description:
      'Épicerie multiculturelle regroupant produits créoles, bushinengué et amérindiens.',
    image:
      'https://images.unsplash.com/photo-1534723452862-4c874018d66d?auto=format&fm=webp&fit=crop&w=800&q=80',
  },
  {
    id: 'gf-002',
    nom: 'Artisan Aïmiti Bijoux',
    categorie: 'Artisanat',
    categorieIcon: Heart,
    categorieColor: 'text-rose-400 bg-rose-400/10',
    territoire: 'Guyane',
    ville: 'Saint-Laurent-du-Maroni',
    adresse: 'Village artisanal du bord du Maroni',
    ...
    local: true,
    description:
      'Artisanat traditionnel des peuples du fleuve. Chaque pièce est unique et certifiée.',
    image:
    ...
    <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl overflow-hidden hover:border-orange-500/40 transition-all">
      ...
      <div className="relative h-36 overflow-hidden">
        ...
        <div className="absolute bottom-2 left-3 right-3 flex items-end justify-between">
          ...
          <span
            className={`text-xs px-2 py-0.5 rounded-full font-semibold flex items-center gap-1 ${c.categorieColor}`}
          >
      ...
      <div className="p-4">
        ...
        <div className="flex items-start gap-1.5 mb-2">
          ...
          <p className="text-xs text-slate-300">
            {c.adresse} · <span className="text-orange-300">{c.ville}</span>
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-1 mb-3">
          {c.specialites.slice(0, 3).map((s) => (
            <span
              key={s}
              className="text-xs bg-slate-700/80 text-slate-300 px-2 py-0.5 rounded-full"
            >
              {s}
            </span>
          ))}
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        ...
        <link
          rel="alternate"
          hrefLang="fr"
          href="https://teetee971.github.io/akiprisaye-web/petits-commerces"
        />
        <link
          rel="alternate"
          hrefLang="x-default"
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16 pt-6">
        ...
        <div className="mb-6">
          ...
          >
            ...
            <p className="text-orange-100 text-sm mt-2 drop-shadow max-w-2xl">
              Trouvez les épiceries, boulangeries, boucheries et artisans locaux de votre
              territoire. Prix repères, horaires et avis citoyens.
            </p>
        ...
        <p className="text-sm text-slate-400 mb-4">
          <span className="font-semibold text-white">{filtered.length}</span> commerce
        ...
        <div className="bg-orange-900/20 border border-orange-700/30 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="flex-1">
            <p className="font-semibold text-orange-300 mb-1">
              📢 Vous connaissez un commerce local ?
            </p>
            <p className="text-sm text-gray-400">
              Signalez-nous les épiceries, artisans et petits commerces de votre quartier. Ensemble,
              construisons l'annuaire citoyen des DOM.
            </p>
          </div>
          <Link
            to="/contribuer-prix"
