...
const GENERAL_COMPARATEURS = [
  ...
  { path: '/paniers-types',          icon: ShoppingCart,      label: 'Paniers types DOM / Métropole', color: 'text-indigo-400', bg: 'bg-indigo-500/10 border-indigo-500/30', desc: 'Comparer le coût des paniers type entre DOM et Hexagone' },
