...
describe('Product Dossier Service', () => {
  ...
  describe('Product Dossier Management', () => {
    ...
    it('should track multiple analyses for same product', async () => {
      await addAnalysisToDossier(mockProductInsight.ean, mockProductInsight, 'label_scan');
  ...
  describe('Product History Service', () => {
    ...
    it('should filter history by territory', async () => {
      ...
      await addAnalysisToDossier(mqInsight.ean, mqInsight, 'label_scan');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing optional fields', async () => {
      ...
      const dossier = await addAnalysisToDossier(minimalInsight.ean, minimalInsight, 'label_scan');
    ...
    it('should handle safeLocalStorage errors gracefully', async () => {
      ...
      // Should not throw
      await expect(
        addAnalysisToDossier(mockProductInsight.ean, mockProductInsight, 'label_scan')
