...
describe('Ingredient Evolution Service - v1.7.0', () => {
  ...
  describe('Feature Flag', () => {
    ...
    it('should process request when feature is enabled', async () => {
      const snapshots = [
        createMockSnapshot('3760074380534', 'TestBrand', '2025-01-01T00:00:00Z', [
          'Farine',
          'Sucre',
        ]),
      ];
  ...
  describe('getIngredientEvolution', () => {
    ...
    it('should detect added ingredients', async () => {
      const snapshots = [
        ...
        createMockSnapshot('3760074380534', 'TestBrand', '2025-02-01T00:00:00Z', [
          'Farine',
          'Sucre',
          'Sel',
        ]),
      ...
      expect(lastEntry.changes.some((c) => c.type === 'added' && c.ingredientName === 'Sel')).toBe(
        true
      );
    });
    ...
    it('should detect removed ingredients', async () => {
      ...
      const lastEntry = timeline[timeline.length - 1];
      expect(
        lastEntry.changes.some((c) => c.type === 'removed' && c.ingredientName === 'Sel')
      ).toBe(true);
    });
    ...
    it('should filter by date range', async () => {
      const snapshots = [
        ...
        createMockSnapshot('3760074380534', 'TestBrand', '2025-03-01T00:00:00Z', [
          'Farine',
          'Sucre',
          'Sel',
        ]),
  ...
  describe('getHistoricalFormulation', () => {
    ...
    it('should return closest snapshot before target date', async () => {
      const snapshots = [
        ...
        createMockSnapshot('3760074380534', 'TestBrand', '2025-09-01T00:00:00Z', [
          'Farine',
          'Sucre',
          'Sel',
        ]),
  ...
  describe('getChangeDetectionStats', () => {
    ...
    it('should calculate statistics across multiple products', async () => {
      ...
      const snapshots2 = [
        ...
        createMockSnapshot('2222222222222', 'BrandB', '2025-03-01T00:00:00Z', [
          'Eau',
          'Sel',
          'Sucre',
        ]),
  ...
  describe('validateSnapshotQuality', () => {
    it('should validate valid snapshot', () => {
      const snapshot = createMockSnapshot('3760074380534', 'TestBrand', '2025-01-01T00:00:00Z', [
        'Farine',
        'Sucre',
      ]);
    ...
    it('should detect missing EAN', () => {
      const snapshot = createMockSnapshot('', 'TestBrand', '2025-01-01T00:00:00Z', [
        'Farine',
        'Sucre',
      ]);
    ...
    it('should detect missing brand', () => {
      const snapshot = createMockSnapshot('3760074380534', '', '2025-01-01T00:00:00Z', [
        'Farine',
        'Sucre',
      ]);
