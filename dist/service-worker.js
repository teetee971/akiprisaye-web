...
}, U = (a) => [f.prefix, a, f.suffix].filter((e) => e && e.length > 0).join("-"), O = (a) => {
...
class G {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), p = h ? await H(
...
class C {
  ...
  handleAll(e) {
    ...
    const t = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, n = "params" in e ? e.params : void 0, r = new G(this, { event: t, request: s, params: n }), i = this._getResponse(r, s, t), c = this._awaitComplete(i, r, s, t);
    return [i, c];
  }
...
class Q {
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: r } = W(s), i = typeof s != "string" && s.revision ? "reload" : "default";
...
ae([{"revision":"b0d79f16d7c74222af3b7ca32e66d6bd","url":"404.html"},{"revision":null,"url":"assets/index-380a7433.js"},{"revision":"2459d3f1330faea7fc8b9b389bfb5313","url":"assets/index-Bt0a5TJk.css"},{"revision":"10772948751ceeb01bcde697c32244b2","url":"assets/index-DsISOSOQ.js"},{"revision":"c2d2dca5924225ae2b300484fa9b9ea2","url":"assets/index-jK_m5Cvo.js"},{"revision":"f135408afeb407db948c6b3c0248fa1b","url":"compare.html"},{"revision":"5e9989bb3cbb6cf216ba0d2bc30035e0","url":"dashboard-admin.html"},{"revision":"e04e0c4835edcad620ca0e6ffd06f815","url":"equivalence.html"},{"revision":"01bd50d011e8ec14e35eb935cb7c2172","url":"index.html"},{"revision":"304dadcb6ae4ee508aaf7eeefdaaffc8","url":"modules/prix_comparateur.js"},{"revision":"c4dbccaab20215df5b0a6ff28073d055","url":"modules/utils_affichage.js"},{"revision":"38013143dc2183340ede8bc1c5124507","url":"registerSW.js"},{"revision":"01aec891eceebfc8dfc26c30afc60cdd","url":"stats.html"},{"revision":"31e19cbdf2829dd6e59c5b9d30a259b0","url":"voix.html"},{"revision":"df786f43e1594a9dcfc91f9a11e7e624","url":"manifest.webmanifest"}] || []);
b(
  ({ request: a }) => a.destination === "script" || a.destination === "style",
  new ie()
);
b(
