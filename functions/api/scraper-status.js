...
export async function onRequest(context) {
  ...
  try {
    ...
    const result = [
      ...
      {
        name: 'Catalogue enseignes (Leclerc / Intermarché / LP / Super U / Cora / Carrefour / Aldi / Score)',
        source: 'catalogue',
    ...
    const fallback = [
      ...
      { name: 'Catalogue enseignes (Leclerc / Intermarché / LP / Super U / Cora / Carrefour / Aldi / Score)',    source: 'catalogue',   status: 'offline', health: 0, lastScan: 'Inconnu', count: 0 },
