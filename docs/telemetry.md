...
Activer via l'un des deux mécanismes :
1. Variable d'environnement build/runtime frontend :
   - `VITE_LOCAL_TELEMETRY=1`
2. Flag local navigateur :
   - `localStorage.setItem("debugTelemetry", "1")`
