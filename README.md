...
[![Version](https://img.shields.io/badge/version-4.7.0-blue)](#-état-du-projet)
...
Les endpoints `/api` ne sont pas servis sur GitHub Pages (hébergement statique) ; le validateur les ignore explicitement pour éviter de faux échecs, sans affaiblir la validation du shell SPA et des assets publics.
